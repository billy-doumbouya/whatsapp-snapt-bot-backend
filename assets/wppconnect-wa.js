  ...
  var __webpack_modules__ = {
      ...
      48287(e, t, r) {
        ...
        function c(e, t, r) {
          ...
          const o = (function (e) {
            ...
            if (void 0 !== e.length)
              return "number" != typeof e.length || Y(e.length) ? s(0) : f(e);
        ...
        const n =
          ...
          g = (e, t) => {
            ...
            const [i, a, s, , c] = o(e),
              [d, f, p, , m] = o(t),
              y = [i, a, s],
              v = [d, null != f ? f : "x", null != p ? p : "x"];
            if (m) {
              if (!c) return !1;
              if (0 !== u(y, v)) return !1;
              if (-1 === u(c.split("."), m.split("."))) return !1;
            }
            const b = v.findIndex((e) => "0" !== e) + 1,
              h = "~" === n ? 2 : b > 1 ? b : 1;
            return (
              0 === u(y.slice(0, h), v.slice(0, h)) &&
              -1 !== u(y.slice(h), v.slice(h))
            );
          },
        ...
        e.exports = (function () {
          ...
          function M() {
            try {
              ...
              var n = t.getImageData(0, 0, 2, 1),
                o = [12, 23, 34, 255, 45, 56, 67, 255];
              return n.data.every(function (e, t) {
                return e === o[t];
              });
            } catch (e) {
              return !1;
          ...
          function O(e, t) {
            ...
            return "data:".concat(t, ";base64,").concat(w(r.join("")));
          }
          function j(e) {
            var t,
              r = new DataView(e);
          ...
          function x(e) {
            var t =
              arguments.length > 1 && void 0 !== arguments[1]
                ? arguments[1]
                : 1e11;
            return C.test(e) ? Math.round(e * t) / t : e;
          }
          function I(e) {
            var t = e.aspectRatio,
              r = e.height,
              ...
              [
                {
                  ...
                  value: function () {
                    ...
                    if (d(t)) {
                      ...
                      if (b(n))
                        if (B && L) {
                          T || ((r.checkOrientation = !1), (r.retainExif = !1));
                          var i = "image/jpeg" === n,
                            a = i && r.checkOrientation,
                            s = i && r.retainExif;
                          if (!B || a || s) {
                            var u = new L();
                            ((this.reader = u),
                              ...
                              a || s
                                ...
                                : u.readAsDataURL(t));
                          } else this.load({ url: B.createObjectURL(t) });
                        } else
                          this.fail(
                            new Error(
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    ((_ = k.width), (P = k.height));
                    var N = I({ aspectRatio: j, width: M, height: w }, "cover");
                    if (((M = N.width), (w = N.height), h)) {
                      var R = I(
                        { aspectRatio: j, width: S, height: C },
                        p.resize,
                      );
                      ((S = R.width), (C = R.height));
                    } else {
                      var F = I({ aspectRatio: j, width: S, height: C }),
                        D = F.width;
                      S = void 0 === D ? r : D;
                      var U = F.height;
                      C = void 0 === U ? n : U;
                    ...
                    var W =
                        -(S = Math.floor(x(Math.min(Math.max(S, M), _)))) / 2,
                      G = -(C = Math.floor(x(Math.min(Math.max(C, w), P)))) / 2,
                      q = S,
                      z = C,
                      $ = [];
                    if (h) {
                    ...
                    ((m.width = S),
                      (m.height = C),
                      b(p.mimeType) || (p.mimeType = d.type));
                    var Z = "transparent";
                      ...
                      var ee = function (e) {
                        if (!t.aborted) {
                          ...
                          if (
                            ...
                            var i = function (e) {
                              return o(l(O(A(e, t.exif), p.mimeType)));
                            };
                            if (e.arrayBuffer)
                              e.arrayBuffer()
                                .then(i)
                  ...
                  value: function (e) {
                    ...
                    if (
                      ...
                      if (
                        ...
                        var s = o.name;
                        s && n.type !== o.type && (s = s.replace(k, h(n.type)));
                        try {
                          n = new File([n], s, { type: n.type });
                        } catch (e) {
                          var u = new Date();
                          ((n.name = s),
                            (n.lastModified = u.getTime()),
                            (n.lastModifiedDate = u));
                        }
                      }
                    else n = o;
        ...
        !(function (o) {
          ...
          function j(e, t, r, n, o) {
            ...
            if (n === o)
              ...
              if ("*" === P) {
                for (s = (b = d(r)).length; s-- > 0; )
                  "_listeners" !== (p = b[s]) &&
                    (h = j(e, t, r[p], n + 1, o)) &&
                    (_ ? _.push.apply(_, h) : (_ = h));
                return _;
              }
              if ("**" === P) {
                for (
                  ...
                  "_listeners" !== (p = b[s]) &&
                    ("*" === p || "**" === p
                      ? (r[p]._listeners &&
                          ...
                          (_ ? _.push.apply(_, h) : (_ = h)),
                        (h = j(e, t, r[p], n, o)))
                      : (h = j(e, t, r[p], p === M ? n + 2 : n, o)),
                    h && (_ ? _.push.apply(_, h) : (_ = h)));
                return _;
              }
            ...
            if (((g = r["*"]) && j(e, t, g, n + 1, o), (m = r["**"])))
              if (n < o)
                for (
                  m._listeners && j(e, t, m, o, o), s = (b = d(m)).length;
                  s-- > 0;
                )
                  "_listeners" !== (p = b[s]) &&
                    (p === M
            ...
            (A.prototype.listenTo = function (e, t, r) {
              ...
              function i(t) {
                ...
                var o,
                  i = r.reducers,
                  a = O.call(n, e);
                o = -1 === a ? new v(n, e, r) : n._observers[a];
                for (
                  var s,
                    u = d(t),
                    c = u.length,
      ...
      63990(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.assertGetProduct = async function (e) {
            const t = (
              await i.CatalogStore.findProduct({
                catalogWid: (0, n.getMyUserWid)(),
                productId: e,
              })
      ...
      75848(e, t, r) {
        ...
        const u = s(r(17833)),
          ...
          d = r(13257),
          f = r(14647),
          p = (0, u.default)("WA-JS:call:registerIncomingCallEvent");
        l.onInjected(() =>
          (function () {
            p("Registering incoming call event listeners");
            const e = new Set(),
              t = f.CallStore.processIncomingCall.bind(f.CallStore);
            f.CallStore.processIncomingCall = function (...r) {
              const n = t(...r);
              return (
                !n ||
                  e.has(n.id) ||
                  (e.add(n.id),
                  p("New call via processIncomingCall", n),
                  c.internalEv.emit("call.incoming_call", {
                    id: n.id,
                    isGroup: n.isGroup,
                    isVideo: n.isVideo,
                    offerTime: n.offerTime,
                    sender: (0, d.createWid)(n.peerJid),
                    peerJid: n.peerJid,
                  })),
                n
              );
      ...
      88617(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.enableCallInterface = async function () {
            (0, n.wrapModuleFunction)(o.getABPropConfigValue, (e, ...t) => {
              const [r] = t;
              switch (r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.end = async function (e) {
            ...
            const r = [
              ...
              i.CALL_STATES.CallActive,
            ];
            let a;
            a = e
              ? o.CallStore.get(e)
              : null !== (t = o.CallStore.activeCall) && void 0 !== t
                ? t
                : void 0;
            if (!a)
              throw new n.WPPError(
            ...
            if (!r.includes(a.getState()) && !a.isGroup)
              throw new n.WPPError(
                "call_is_not_outcoming_calling",
                `Call ${e || "<empty>"} is not incoming calling`,
                { callId: e, state: a.getState() },
              );
            a.peerJid.isGroupCall() ||
              (await o.websocket.ensureE2ESessions([a.peerJid]));
      ...
      96263(e, t, r) {
        ...
        var o = r(88617);
        Object.defineProperty(t, "enableCallInterface", {
          enumerable: !0,
          get: function () {
      ...
      82349(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.offer = async function (e, t = {}) {
            ...
            const d = a.functions.randomHex(16).substr(0, 64),
              f = (0, o.getMyUserId)();
            if (!f)
              throw new i.WPPError(
                "user_id_is_null",
                "My user id is null or undefined",
              );
            const p = [
              a.websocket.smax("audio", { enc: "opus", rate: "16000" }, null),
              a.websocket.smax("audio", { enc: "opus", rate: "8000" }, null),
            ];
            t.isVideo &&
              p.push(
                a.websocket.smax(
            ...
            p.push(
              a.websocket.smax("net", { medium: "3" }, null),
              a.websocket.smax(
                "capability",
                { ver: "1" },
                new Uint8Array([1, 4, 255, 131, 207, 4]),
              ),
              a.websocket.smax("encopt", { keygen: "2" }, null),
            );
            const g = self.crypto.getRandomValues(new Uint8Array(32)).buffer;
            p.push(...(await (0, l.prepareDestionation)([r], g)));
            const m = a.websocket.smax(
                "call",
                {
                  to: r.toString({ legacy: !0 }),
                  id: a.functions.randomHex(8),
                },
                [
                  a.websocket.smax(
                    "offer",
                    {
                      "call-id": d,
                      "call-creator": f.toString({ legacy: !0 }),
                    },
                    p,
                  ),
                ],
              ...
              y = new a.CallModel({
                ...
                isGroup: !1,
                outgoing: !0,
                offerTime: (0, u.unixTime)(),
                webClientShouldHandle: !1,
                canHandleLocally: !0,
              });
            (a.CallStore.add(y),
              a.CallStore.setActiveCall(a.CallStore.assertGet(d)),
              y.setState(s.CALL_STATES.OUTGOING_CALLING));
            const v = await a.websocket.sendSmaxStanza(m);
            return (
              console.info(v),
              console.info((0, c.parseRelayResponse)(v)),
              y
            );
          }));
        const n = r(41687),
          ...
          (t.reject = async function (e) {
            ...
            t = e
              ...
              : i.CallStore.findFirst(
                  (e) =>
                    e.getState() === a.CALL_STATES.INCOMING_RING ||
                    e.isGroup ||
                    e.getState() === a.CALL_STATES.ReceivedCall ||
                    e.isGroup,
                );
            if (!t)
            ...
            if (
              t.getState() !== a.CALL_STATES.INCOMING_RING &&
              t.getState() !== a.CALL_STATES.ReceivedCall &&
              !t.isGroup
            )
              throw new o.WPPError(
                "call_is_not_incoming_ring",
            ...
            t.peerJid.isGroupCall() ||
              (await i.websocket.ensureE2ESessions([t.peerJid]));
            const r = i.websocket.smax(
              "call",
              {
                from: (0, n.getMyUserWid)().toString({ legacy: !0 }),
                to: t.peerJid.toString({ legacy: !0 }),
                id: i.websocket.generateId(),
              },
              [
                i.websocket.smax(
                  "reject",
            ...
            return (await i.websocket.sendSmaxStanza(r), !0);
          }));
        const n = r(21942),
          o = r(62857),
          i = r(14647),
      ...
      74553(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.remove = async function (e, t) {
            ...
            return (
              await (0, i.deleteProductFromCart)(e, t),
              o.CartStore.findCart(e)
            );
          }));
        const n = r(62857),
          o = r(14647),
      ...
      24393(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.submit = async function (e, t, r) {
            ...
            if (
              (await (0, u.addAndSendMsgToChat)(g, v),
              (0, u.updateCart)(p),
              await (0, c.clear)(e),
              !m.id)
            )
      ...
      11561(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.createProduct = async function (e) {
            ...
            const c = o.UserPrefs.getMaybeMePnUser(),
              l = o.UserPrefs.getMaybeMeLidUser();
            ((u.catalogWid = c || l),
              (u.imageCdnUrl = s),
      ...
      59196(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.removeProductImage = async function (e, t) {
            const r = await (0, n.assertGetProduct)(e);
            return (
              r.additionalImageCdnUrl.splice(t, 1),
              (0, o.editProduct)(r)
            );
          }));
        const n = r(41687),
      ...
      85719(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setProductVisibility = async function (e, t) {
            return (
              await (0, o.productVisibilitySet)(e, t),
        ...
        u.onFullReady(function () {
          function e(e) {
            ...
            const t = e.from,
              ...
              n = c.UserPrefs.getMaybeMePnUser(),
              o = c.UserPrefs.getMaybeMeLidUser(),
              i = e.from,
              a =
                !e.recipient ||
                (null == n ? void 0 : n.equals(e.recipient)) ||
                (null == o ? void 0 : o.equals(e.recipient));
            if (!a) return;
            const u = e.externalIds.map(
              (t) =>
                new c.MsgKey({
                  id: t,
                  remote: i,
      ...
      59474(e, t, r) {
        ...
        const s = r(13691),
          ...
          c = r(14647);
        u.onInjected(() => {
          c.ChatStore.on("add", (e) => {
            queueMicrotask(() => {
              s.internalEv.emit("chat.new_chat", e);
            });
          });
        });
      },
            ...
            void 0 === c.MsgModel.prototype.isGroupMsg &&
              Object.defineProperty(c.MsgModel.prototype, "isGroupMsg", {
                get: function () {
                  ...
                  return null ===
                    (t =
                      null === (e = null == this ? void 0 : this.chat) ||
                      void 0 === e
                        ? void 0
                        : e.id) || void 0 === t
                    ? void 0
                ...
                if (t[1]) {
                  ...
                  ((p[r.msgKey] = r),
                    s.internalEv.emitAsync("chat.new_reaction", {
                      ...
                      read: r.read,
                      sender: (0, c.createWid)(r.senderUserJid),
                      timestamp: r.t,
                    }),
                    setTimeout(() => {
                      delete p[r.msgKey];
      ...
      59798(e, t, r) {
        ...
        const s = r(13691),
          ...
          c = r(14647);
        u.onInjected(() => {
          c.ChatStore.on("change:unreadCount", (e, t, r) => {
            (l && clearTimeout(l),
              (l = setTimeout(() => {
                s.internalEv.emit("chat.unread_count_changed", {
                  chat: e,
                  unreadCount: t,
                  previousUnreadCount: r,
                });
              }, 50)));
          });
        });
                                                      ...
                                                      urlButton: {
                                                        displayText:
                                                          (null ===
                                                            ...
                                                            : a.display_text) ||
                                                          " ",
                                                        url: `https://www.whatsapp.com/otp/code/?otp_type=COPY_CODE&code=otp${null === (s = JSON.parse(e.buttonParamsJson)) || void 0 === s ? void 0 : s.copy_code}`,
                                                      },
                                                    }
                                                  : "cta_call" == e.name
                                                    ? {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.deleteMessage = async function (e, t, r = !1, c = !1) {
            ...
            for (const t of f) {
              ...
              let g = !1;
              l.id.isGroup() && (g = await (0, i.iAmAdmin)(e));
              const m = f || g;
      ...
      48157(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.downloadMedia = async function e(t) {
            var r;
            const n = await (0, s.getMessageById)(t);
            if (!n.mediaData)
              throw new i.WPPError(
            ...
            const o = n.mediaData,
              c = async () => {
                ...
                if (
                  r &&
                  "function" ==
                    typeof (null === a.LruMediaStore ||
                    void 0 === a.LruMediaStore
                      ? void 0
                      : a.LruMediaStore.get)
                ) {
                  const e = await a.LruMediaStore.get(r).catch(() => null),
                    t = (0, i.toArrayBuffer)(e);
                  if (t)
                    return (
                      u("Media found in LruMediaStore cache for filehash", r),
                      new Blob([t], {
                        type: o.mimetype || "application/octet-stream",
                      })
                    );
                }
                if (
                  ...
                  (null ===
                    (e =
                      null === a.MediaBlobCache || void 0 === a.MediaBlobCache
                        ? void 0
                        : a.MediaBlobCache.has) || void 0 === e
                    ? void 0
                    : e.call(a.MediaBlobCache, r))
                )
                  return (
                    u("Media found in MediaBlobCache for filehash", r),
                    a.MediaBlobCache.get(r)
                  );
                if (o.mediaBlob) {
                  const e = o.mediaBlob.forceToBlob();
                  if (e)
                    return (u("Media found in mediaBlob for message", t), e);
                }
                return null;
              },
              l = await c();
            if (l) return l;
            (u("Downloading media for message", t),
            ...
            if (
              !d &&
              "VIDEO" ===
                (null === (r = n.mediaObject) || void 0 === r ? void 0 : r.type)
            ) {
              u("Retrying download as document for message", t);
              try {
                return (
                  (n.type = "document"),
                  (n.mediaObject.type = "DOCUMENT"),
                  await e(t)
                );
              } finally {
                ((n.type = "video"), (n.mediaObject.type = "VIDEO"));
              }
            }
            if (!d)
              throw (
                u("Media not found after download for message", t),
                {
                  error: !0,
        ...
        const o = n(r(17833)),
          ...
          a = r(14647),
          s = r(97829),
          u = (0, o.default)("WA-JS:chat:downloadMedia");
      },
      35090(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.editMessage = async function (e, t, r = {}) {
            ...
            return (
              (d = await (0, s.prepareRawMessage)(f, d, r)),
              (d.latestEditMsgKey = d.id),
              (d.latestEditSenderTimestampMs = d.t),
              await (0, s.sendRawMessage)(f.id, d, r)
            );
          }));
        const n = r(41687),
          o = r(62857),
      ...
      36618(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.find = async function (e) {
            var t;
            const r = (0, n.assertWid)(e),
              a = await (0, i.findOrCreateLatestChat)(r, "newChatFlow");
            if (
              !(null === (t = null == a ? void 0 : a.chat) || void 0 === t
                ? void 0
                : t.id)
            )
              throw new Error(
                `Failed to find or create chat for ${r.toString()}`,
              );
            const s = o.ChatStore.get(a.chat.id);
            if (!s)
              throw new Error(
                `Chat not found in ChatStore for ${r.toString()}`,
              );
      ...
      59580(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.forwardMessages = async function (e, t, r = {}) {
            var s, u, c;
            const l = await (0, n.assertFindChat)(e),
              d = [];
            for (const e of t)
              e instanceof o.MsgModel
                ? d.push(e)
                : d.push(await (0, a.getMessageById)(e));
            return await (0, i.forwardMessages)({
              chat: l,
              msgs: d,
              multicast: null !== (s = r.multicast) && void 0 !== s && s,
              includeCaption:
                null !== (u = r.displayCaptionText) && void 0 !== u && u,
              appendedText: null !== (c = r.appendedText) && void 0 !== c && c,
            });
          }));
        const n = r(41687),
          o = r(14647),
          ...
          (t.generateMessageID = async function (e) {
            ...
            r =
              t.isGroup() || t.isLid()
                ? (0, o.getMyUserLid)()
                : (0, o.getMyUserWid)();
            const s = t.isGroup() ? r : void 0;
            return new i.MsgKey({
              from: r,
              to: t,
              id: await Promise.resolve((0, a.randomMessageId)()),
              participant: s,
              selfDir: "out",
            });
          }));
      ...
      11513(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getActiveChat = function () {
            return (
              n.ChatStore.findFirst((e) => e.active) ||
              n.NewsletterStore.findFirst((e) => e.active)
            );
          }));
        const n = r(14647);
      },
              ...
              if (!l)
                if (d) l = s.StatusV3Store.getMyStatus().msgs.get(e);
                  ...
                  if (((l = t.msgs.get(e)), !l)) {
                    ...
                    const r = (0, u.callGetSearchContext)(t, e);
      ...
      48769(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessages = async function (e, t = {}) {
            ...
            let c = t.count || 20;
            const l = "after" === t.direction ? "after" : "before",
              d =
                t.id ||
                (null === (r = u.lastReceivedKey) || void 0 === r
                  ? void 0
                  : r.toString());
            if (t.onlyUnread) {
              if (!u.hasUnread) return [];
              const e = u.unreadCount < 0 ? 2 : u.unreadCount;
              c = c < 0 ? e : Math.min(c, e);
            }
            -1 === c && (0, o.isMultiDevice)() && (c = 1 / 0);
            !t.id && d && c--;
            const f = "function" == typeof s.msgFindQuery,
              p =
                f && d
                  ? i.MsgKey.fromString(d)
                  : { remote: u.id, count: c, direction: l };
            f && ((p.count = c), (p.direction = l));
            const g = d ? i.MsgKey.fromString(d) : void 0;
            let m = [];
            if ("all" === t.media)
              if (f) {
                const { messages: e } = await (0, s.msgFindQuery)("media", p);
                Array.isArray(e) && m.push(...e);
              } else {
                const e = await (0, s.msgFindMedia)({
                  anchor: g,
                  count: c,
                  mediaType: "allMedia",
                  direction: l,
                ...
                Array.isArray(e)
                  ? m.push(...e)
                  : (null == e ? void 0 : e.messages) && m.push(...e.messages);
              }
            else if ("image" === t.media)
              if (f) {
                const { messages: e } = await (0, s.msgFindQuery)("media", p);
                for (const t of e) "image" === t.type && m.push(t);
              } else {
                const e = await (0, s.msgFindMedia)({
                    anchor: g,
                    count: c,
                ...
                for (const e of t) "image" === e.type && m.push(e);
              }
            ...
            else if (f) m = await (0, s.msgFindQuery)(l, p);
            else {
              if (!g) return [];
              const e = await (0, s.msgFindByDirection)({
                anchor: g,
                count: c,
                direction: l,
              });
            ...
            if (!t.id && d) {
              const e = i.MsgStore.get(d);
              e && m.push(e.attributes);
            }
            if (
              ((m = m.map(
                (e) => (
              ...
              t.includeCallMessages)
            )
              try {
                let e;
                if (
                  ((e = f
                    ? await (0, s.msgFindQuery)(a.MSG_TYPE.CALL_LOG, p)
                    : await (0, s.msgFindCallLog)({ anchor: g, count: c })),
                  e && e.length > 0)
                ) {
                  const t = e.map((e) =>
                    e instanceof i.MsgModel
                  ...
                  (m.push(...t),
                    m.sort((e, t) => {
                      const r = e.t || e.timestamp || 0,
                        n = t.t || t.timestamp || 0;
                      return "before" === l ? n - r : r - n;
                    }),
                    c > 0 && c !== 1 / 0 && (m = m.slice(0, c)));
                }
              } catch (e) {
      ...
      81755(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getUnreadChats = async function (e) {
            return e ? i : await (0, o.list)({ onlyWithUnreadMessage: !0 });
          }));
        const n = r(13691),
          o = r(88241);
        let i = [];
        (0, n.on)("chat.unread_count_changed", (e) => {
          e.unreadCount > 0
            ? i.find((t) => {
                var r;
                return (
                  t.id ===
                  (null === (r = e.chat) || void 0 === r ? void 0 : r.id)
                );
              }) || i.push(e.chat)
            : (i = i.filter((t) => {
                var r;
      ...
      97829(e, t, r) {
        ...
        var m = r(59580);
        Object.defineProperty(t, "forwardMessages", {
          enumerable: !0,
          get: function () {
        ...
        var x = r(81755);
        Object.defineProperty(t, "getUnreadChats", {
          enumerable: !0,
          get: function () {
        ...
        Object.defineProperty(t, "prepareRawMessage", {
          enumerable: !0,
          get: function () {
            return V.prepareRawMessage;
          },
        });
        var K = r(4009);
        Object.defineProperty(t, "replyToButtonMessage", {
          enumerable: !0,
          get: function () {
            return K.replyToButtonMessage;
          },
        });
        var J = r(58267);
      ...
      88241(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.list = async function (e = {}) {
            ...
            e.onlyGroups && (i = i.filter((e) => e.id.isGroup()));
            e.onlyCommunities &&
              (i = i.filter((e) => {
                var t;
                return (
            ...
            e.onlyArchived && (i = i.filter((e) => e.archive));
            if (e.withLabels) {
            ...
            if (!(null == e ? void 0 : e.ignoreGroupMetadata))
              for (const e of i)
                e.id.isGroup() && (await n.GroupMetadataStore.find(e.id));
            return i;
          }));
        const n = r(14647),
          o = r(63829);
      ...
      59680(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.markIsRead = async function (e) {
            const t = (0, o.assertGetChat)(e),
              r = t.unreadCount;
            (0, n.compare)(i.SANITIZED_VERSION_STR, "2.3000.1031992593", ">=")
              ? await (0, a.sendSeen)({ chat: t, afterAvailable: !1 })
              : await (0, a.sendSeen)(t, !1);
            return { wid: t.id, unreadCount: r };
          }));
        const n = r(38385),
          o = r(41687),
          i = r(19198),
      ...
      91082(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatAt = async function (e, t, r) {
            const s = (0, n.assertWid)(e),
              u = await (0, n.assertFindChat)(s),
              c = await (0, a.getMessageById)(t);
            try {
              const e = (0, i.callGetSearchContext)(u, c);
              return await o.Cmd.openChatAt(u, e);
            } catch (e) {
              const t = (0, i.callGetSearchContext)(u, c.id._serialized);
              return await o.Cmd.openChatAt({
                chat: u,
                msgContext: t,
                chatEntryPoint: r,
              });
      ...
      74212(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatBottom = async function (e, t) {
            var r;
            const s = (0, n.assertWid)(e),
              u = await (0, a.findOrCreateLatestChat)(s, "newChatFlow");
            if (
              !(null === (r = null == u ? void 0 : u.chat) || void 0 === r
                ? void 0
                : r.id)
            )
              throw new Error(
                `Failed to find or create chat for ${s.toString()}`,
              );
            const c = i.ChatStore.get(u.chat.id);
            if (!c)
              throw new Error(
                `Chat not found in ChatStore for ${s.toString()}`,
              );
            if ((0, o.isWhatsAppVersionLTE)("2.3000.1029960097"))
              return await i.Cmd.openChatBottom(c, t);
            return await i.Cmd.openChatBottom({ chat: c, chatEntryPoint: t });
          }));
        const n = r(41687),
          o = r(64120),
          i = r(14647),
      ...
      51464(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.openChatFromUnread = async function (e, t) {
            var r;
            const s = (0, n.assertWid)(e),
              u = await (0, a.findOrCreateLatestChat)(s, "newChatFlow");
            if (
            ...
            if ((0, o.isWhatsAppVersionLTE)("2.3000.1029960097"))
              return await i.Cmd.openChatFromUnread(c);
            return await i.Cmd.openChatFromUnread({
              chat: c,
              chatEntryPoint: t,
            });
          }));
      ...
      6993(e, t, r) {
        ...
        const n = r(41687),
          ...
          s = r(52757),
          u = r(17530);
        async function c(e, t = !0, r = a.PinExpiryDurationOption.SevenDays) {
          var c, l, d, f, p;
          let g = a.PinExpiryDurationOption.SevenDays;
          if ("number" == typeof r)
            (console.warn(
              `[WPP.chat.pinMsg] DEPRECATION WARNING: Passing numbers as duration is deprecated. The value ${r} will be ignored and default to 7 days. Please use PinExpiryDurationOption enum instead (e.g., PinExpiryDurationOption.SevenDays).`,
            ),
              (g = a.PinExpiryDurationOption.SevenDays));
          else {
            const e = Object.values(a.PinExpiryDurationOption);
            e.includes(r)
              ? (g = r)
              : (console.warn(
                  `[WPP.chat.pinMsg] Invalid PinExpiryDurationOption: ${r}. Falling back to SevenDays. Valid options: ${e.join(", ")}`,
                ),
                (g = a.PinExpiryDurationOption.SevenDays));
          }
          if ("boolean" != typeof t)
            throw new o.WPPError(
              ...
              "The 'pin' parameter must be a boolean. Received: " + typeof t,
              { msgId: e, pin: t, duration: r },
            );
          const m = await (0, u.getMessageById)(e),
            y = (0, n.assertGetChat)(m.id.remote),
            v = i.PinInChatStore.getByParentMsgKey(m.id);
          if (y.id.isNewsletter())
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
          ...
          if (
            ...
            !(null ===
              (l =
                null === (c = y.groupMetadata) || void 0 === c
                  ? void 0
          ...
          if (
            y.id.isGroup() &&
            ((null === (d = y.groupMetadata) || void 0 === d
              ? void 0
              : d.restrict) ||
              (null === (f = y.groupMetadata) || void 0 === f
                ? void 0
                : f.announce)) &&
            !(null === (p = y.groupMetadata) || void 0 === p
              ? void 0
          ...
          if (
            m.isNotification ||
            m.isViewOnce ||
            m.type === a.MSG_TYPE.REVOKED ||
            ((null == m ? void 0 : m.ack) || 0) < a.ACK.SENT
          )
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
          ...
          if (v && v.pinType === (t ? a.PIN_STATE.PIN : a.PIN_STATE.UNPIN))
            throw new o.WPPError(
              (t ? "pin" : "unpin") + "_error",
          ...
          const b = t ? g : void 0,
            h = await (0, s.sendPinInChatMsg)(
              m,
              !0 === t ? a.PIN_STATE.PIN : a.PIN_STATE.UNPIN,
              b,
            );
          if (!h)
            throw new o.WPPError(
              "pin_send_error",
              `Failed to ${t ? "pin" : "unpin"} message ${e.toString()}`,
              { msgId: e, pin: t },
            );
          return {
            message: m,
            pinned: h.messageSendResult === a.SendMsgResult.OK ? t : !t,
            result: h.messageSendResult,
          };
        }
      },
      72185(e, t, r) {
              ...
              async (e, ...t) => {
                ...
                return new Promise(async (r) => {
                  try {
                    ...
                    let i = {};
                    t &&
                      (i = await (0, c.generateThumbnailLinkPreviewData)(
                        t,
                      ).catch(() => null));
      ...
      19211(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.prepareRawMessage = async function (e, t, r = {}) {
            ...
            t.id || (t.id = await (0, f.generateMessageID)(e));
            ...
            if (
              ...
              if (o.length > 0) {
                const t = (await (0, i.getParticipants)(e.id)).map((e) =>
                  e.id.toString(),
                );
                for (const e of o) {
                  const n = `${e}@lid`,
                    o = `${e}@c.us`;
                  t.includes(n)
                    ? r.mentionedList.push(n)
                    : t.includes(o) && r.mentionedList.push(o);
                }
              }
            }
            if (r.mentionedList) {
            ...
            let v = !1;
            r.quotedMsgPayload &&
              ((r.quotedMsg = (0, d.rehydrateMessage)(r.quotedMsgPayload)),
              (v = !0));
            if (r.quotedMsg) {
              if (
                ...
                r.quotedMsg instanceof s.MsgKey &&
                  (r.quotedMsg = await (0, f.getMessageById)(r.quotedMsg)),
      ...
      4009(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.replyToButtonMessage = async function (e, t, r) {
            const { buttonIndex: a } = r,
              s = (0, i.get)(e);
            if (!s)
              throw new n.WPPError("chat_not_found", `Chat ${e} not found`);
            const u = s.msgs.get(t);
            if (!u)
              throw new n.WPPError(
                "message_not_found",
                `Message ${t} not found`,
              );
            if (!u.hydratedButtons || !Array.isArray(u.hydratedButtons))
              throw new n.WPPError(
                "no_buttons_in_message",
                "This message does not have buttons",
              );
            if (a < 0 || a >= u.hydratedButtons.length)
              throw new n.WPPError(
                "invalid_button_index",
                `Button index ${a} is out of range. Valid range: 0-${u.hydratedButtons.length - 1}`,
              );
            const c = u.hydratedButtons[a];
            let l, d, f;
            if (c.quickReplyButton)
              ((l = c.quickReplyButton.id),
                (d = c.quickReplyButton.displayText),
                (f = "quick_reply"));
            else if (c.urlButton)
              ((l = `${c.index}`), (d = c.urlButton.displayText), (f = "url"));
            else {
              if (!c.callButton)
                throw new n.WPPError(
      ...
      82028(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendChargeMessage = async function (e, t, r) {
            ...
            let l = 0,
              d = null;
            const f = (0, n.getMyUserWid)(),
              p = i.CatalogStore.get(f);
            for (const e of t)
              if ("product" == e.type) {
                const { data: t } = await (0, a.queryProduct)(
                  f,
                  e.id,
                  100,
                  100,
                ...
                const n = (null == p ? void 0 : p.productCollection).get(e.id);
                if (!d) {
                  d = n
                ...
                ((l += Number(t.price) * Number(e.qnt || 1)), c.push(i));
              } else {
                const t = {
                  retailer_id: `custom-item-${(0, o.generateOrderUniqueId)()}`,
                  name: e.name,
                  amount: {
                ...
                ((l += Number(e.price) * Number(e.qnt || 1)), c.push(t));
              }
            const g =
                l +
              ...
              m = {
                reference_id: (0, o.generateOrderUniqueId)(),
                type: "physical-goods",
                payment_configuration: "merchant_categorization_code",
                currency: await (0, a.currencyForCountryShortcode)(
                  await (0, a.getCountryShortcodeByPhone)(
                    i.UserPrefs.getMaybeMePnUser().user,
                  ),
                ),
                total_amount: { value: g, offset: Number(r.offset) || 1e3 },
                order_type: "ORDER",
                order: {
                  status: "pending",
                  items: c,
              ...
              y = {
                ...
                interactivePayload: {
                  buttons: [
                    {
                      buttonParamsJson: JSON.stringify(m),
                      name: "review_and_pay",
                    },
                  ],
                  messageVersion: 1,
            ...
            return await (0, u.sendRawMessage)(e, y, r);
          }));
        const n = r(21942),
          o = r(62857),
          i = r(14647),
      ...
      35824(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendEventMessage = async function (e, t) {
            ...
            const r = new Date(1e3 * t.startTime);
            r.setHours(r.getHours() + 2);
            const s = Math.floor(r.getTime() / 1e3),
              u = {
                type: "event_creation",
                eventName: t.name || " ",
                ...
                eventEndTime: (null == t ? void 0 : t.endTime) || s,
                isEventCanceled: !1,
                ...
                eventJoinLink:
                  "string" == typeof (null == t ? void 0 : t.callType)
                    ? await (0, o.createEventCallLink)(t.startTime, t.callType)
                    : void 0,
              };
            return await (0, a.sendRawMessage)(e, u, t);
          }));
        const n = r(62857),
          o = r(52757),
          i = r(74023),
      ...
      24654(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendFileMessage = async function (e, t, r) {
            ...
            ((r = Object.assign(
              ...
              (a =
                "status@broadcast" == (null == e ? void 0 : e.toString())
                  ? new g.ChatModel({ id: (0, d.createWid)(v.STATUS_JID) })
                  : await (0, c.assertFindChat)(e)));
            const s = await (0, d.convertToFile)(t, r.mimetype, r.filename),
              u = s.name,
              l = (0, f.getMediaTypeForValidation)(r.type, s.type),
              y = "status@broadcast" === (null == e ? void 0 : e.toString());
            try {
              const e = y ? "STATUS_TAB_CAMERA_PHOTO_LIBRARY" : null,
                t = p.MediaGatingUtils.getUploadLimit(l, e);
              if (
                (P(
                  `Validating file size: ${s.size} bytes, limit for ${l}: ${t} bytes`,
                ),
                s.size > t)
              )
                throw new d.WPPError(
                  "file_too_large",
                  `File size ${(0, f.formatFileSize)(s.size)} exceeds the upload limit of ${(0, f.formatFileSize)(t)} for ${l} files`,
                  { fileSize: s.size, limit: t, mediaType: l },
                );
            } catch (e) {
              if (e instanceof d.WPPError) throw e;
            }
            const M = await g.OpaqueData.createFromData(s, s.type),
              w = {};
            let O, j;
            "audio" === r.type
              ? ((w.isPtt = r.isPtt),
                r.isPtt && (O = r.isViewOnce),
                (w.precomputedFields = await (0, _.prepareAudioWaveform)(r, s)))
              : "image" === r.type
                ? ((O = r.isViewOnce),
                  (j = (null == r ? void 0 : r.isHD) ? 2560 : 1600))
                : "video" === r.type
                  ? ((O = r.isViewOnce), (w.asGif = r.isGif))
                  : "document" === r.type
                    ? (w.asDocument = !0)
                    : "sticker" === r.type && (w.asSticker = !0);
            const S = g.MediaPrep.prepRawMedia(
              M,
              Object.assign(Object.assign({}, w), { maxDimension: j }),
            );
            let C = await (0, h.prepareRawMessage)(
              a,
              {
                caption: r.caption || u,
                filename: u,
            ...
            ((C = (0, h.prepareMessageButtons)(C, r)),
              r.markIsRead &&
                (P("marking chat is read before send file"),
                await (0, h.markIsRead)(a.id).catch(() => null)));
            await S.waitForPrep();
            const x = S._mediaData || S.mediaData;
            (null == r ? void 0 : r.isPtv) &&
              ((x.type = "ptv"), (x.fullHeight = 1128), (x.fullWidth = 1128));
            P(`sending message (${r.type}) with id ${C.id}`);
            const I = {
              caption: r.caption,
              footer: r.footer,
              isViewOnce: O,
              productMsgOptions: "status@broadcast" === e ? void 0 : C,
              addEvenWhilePreparing: !1,
              type: C.type,
            };
            let E;
            E =
              1 === S.sendToChat.length
                ? S.sendToChat({ chat: a, options: I })
                : S.sendToChat(a, I);
            let A = null;
            A =
              "status@broadcast" ==
              (null === (n = C.to) || void 0 === n ? void 0 : n.toString())
                ? await new Promise((e) => {
                    g.StatusV3Store.on(
                      ...
                      async function t(r, n) {
                        ...
                        if (
                          r.id.toString() ==
                          (null === (o = C.from) || void 0 === o
                            ? void 0
                            : o.toString())
                        ) {
                          g.StatusV3Store.off("change:lastReceivedKey", t);
                ...
                : await new Promise((e) => {
                    a.msgs.on("add", function t(r) {
                      r.id === C.id && (a.msgs.off("add", t), e(r));
                    });
                  });
            function T(e, t) {
              P(`message file ${A.id} is ${t}`);
            }
            if (
              (P(`message file ${A.id} queued`),
              A.on("change:mediaData.mediaStage", T),
              E.finally(() => {
                A.off("change:mediaData.mediaStage", T);
              }),
              "status@broadcast" !== e)
            ) {
              if (r.waitForAck) {
                P(`waiting ack for ${A.id}`);
                const e = await E;
                P(
                  `ack received for ${A.id} (ACK: ${A.ack}, SendResult: ${JSON.stringify(e)})`,
                );
              }
              return {
                id: null === (o = A.id) || void 0 === o ? void 0 : o.toString(),
                ack: A.ack,
                sendMsgResult: E,
              };
            }
            {
              const e = await new Promise((e, t) => {
                const r = setTimeout(() => {
                  ...
                  n = setInterval(async () => {
                    const t = await (0, h.getMessageById)(A.id);
        ...
        const u = s(r(17833)),
          ...
          h = r(97829),
          _ = r(72185),
          P = (0, u.default)("WA-JS:message");
        l.onFullReady(() => {
          ((0, y.wrapModuleFunction)(
            v.generateVideoThumbsAndDuration,
            async (e, ...t) => {
              const [r] = t;
              try {
                return await e(...t);
                ...
                if (
                  ...
                  try {
                    const e = await r.file.arrayBuffer(),
                      t = (0, d.getVideoInfoFromBuffer)(e);
                    return {
                      duration: t.duration,
            ...
            (0, y.wrapModuleFunction)(v.processRawSticker, async (e, ...t) => {
              const [r] = t,
                n = await e(...t);
              if ("image/webp" === r.type()) {
                const e = r.forceToBlob(),
                  t = await (0, d.blobToArrayBuffer)(e);
                (0, v.isAnimatedWebp)(t) &&
                  (n.mediaBlob = await g.OpaqueData.createFromData(
                    e,
                    r.type(),
                  ));
              }
            ...
            (0, y.wrapModuleFunction)(v.uploadMedia, async (e, ...t) => {
              const [r] = t;
      ...
      44190(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendRawMessage = async function (e, t, r = {}) {
            ...
            const o = await (0, i.assertFindChat)(e);
            if (o.id.isGroup() && o.isParentGroup) {
              ...
              if ("COMMUNITY" == (null == e ? void 0 : e.groupType)) {
                ...
                throw new s.WPPError(
                  ...
                  `You can not send message to this groupType 'COMMUNITY', send for Announcement Group. Correct announcement groupId: ${null == t ? void 0 : t.toString()}`,
                );
              }
            }
            ...
            if ((null == o ? void 0 : o.isNewsletter) && t.type) {
              ...
              (await (0, l.addAndSendMessageEdit)(e, t),
                (g = [
                  await (0, f.getMessageById)(t.protocolMessageKey),
                  null,
                ]));
            ...
            r.waitForAck &&
              ...
              g[1] && (y = await g[1]),
              p(
                `ack received for ${t.id} (ACK: ${m.ack}, SendResult: ${null == y ? void 0 : y.messageSendResult})`,
              ));
          ...
          (t.sendVCardContactMessage = async function (e, t, r = {}) {
            ...
            for (const e of t) {
              ...
              "object" == typeof e && "name" in e
                ...
                : (t = e.toString());
              let a = i.ContactStore.get(t);
              a ||
                (a = new i.ContactModel({ id: (0, n.assertWid)(t), name: r }));
              const s = (0, o.getMyUserWid)();
              (!r && a.id.equals(s) && (r = a.displayName),
                r &&
                  ((a = new i.ContactModel(a.attributes)),
                  (a.name = r),
                  Object.defineProperty(a, "formattedName", { value: r }),
                  Object.defineProperty(a, "displayName", { value: r })),
                u.push(i.VCard.vcardFromContactModel(a)));
            }
            const c = {};
            1 === u.length
              ? ((c.type = "vcard"),
                (c.body = u[0].vcard),
                (c.vcardFormattedName = u[0].displayName))
              : ((c.type = "multi_vcard"), (c.vcardList = u));
            return (0, s.sendRawMessage)(e, c, r);
          }));
        const n = r(41687),
          o = r(21942),
          i = r(14647),
      ...
      43859(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.setChatList = async function (e, t) {
            ...
            if (e == g.CUSTOM && !t)
              throw new u.WPPError("send_ids", "Please send a valid ids");
            "string" == typeof t && (t = [t]);
            return e == g.CUSTOM && t
              ? ((f = new Set(t)),
      ...
      72465(e, t, r) {
        ...
        (s.onFullReady(function () {
          ((0, c.wrapModuleFunction)(l.mediaTypeFromProtobuf, (e, ...t) => {
            ...
            (0, c.wrapModuleFunction)(l.isLidMigrated, (e, ...t) => {
              try {
                return e(...t);
              } catch (e) {
                return !1;
          ...
          s.onFullReady(function () {
            const e = {
              ...
              isUser: (e) => e.id.isUser(),
              isPSA: (e) => e.id.isPSA(),
              isGroup: (e) => e.id.isGroup(),
              isNewsletter: (e) => e.id.isNewsletter(),
      ...
      8e3(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }), o(r(7345), t));
      },
      7345(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.rehydrateMessage = function (e) {
            var t;
            if (!e) return;
            if (e instanceof n.MsgModel) return e;
            const r = JSON.parse(e);
            r.quotedMsg && delete r.quotedMsg;
            "string" == typeof r.id
              ? (r.id = n.MsgKey.fromString(r.id))
              : "object" == typeof r.id &&
                null !== r.id &&
                (r.id = new n.MsgKey({
                  fromMe: r.id.fromMe,
                  remote: n.WidFactory.createWid(r.id.remote),
                  id: r.id.id,
                  participant: r.id.participant
                    ? n.WidFactory.createWid(r.id.participant)
                    : void 0,
                }));
            r.from && (r.from = n.WidFactory.createWid(r.from));
            r.to && (r.to = n.WidFactory.createWid(r.to));
            r.author && (r.author = n.WidFactory.createWid(r.author));
            r.messageSecret &&
              "object" == typeof r.messageSecret &&
              (r.messageSecret = new Uint8Array(
                Object.values(r.messageSecret),
              ));
            (delete r.rowId,
              delete r.labels,
              delete r.groupMentions,
              delete r.nonJidMentions,
              delete r.mentionedJidList);
            const o = new n.MsgModel(r),
              i =
                null === (t = o.msgContextInfo) || void 0 === t
                  ? void 0
                  : t.bind(o);
            i &&
              (o.msgContextInfo = function (e) {
                const t = i(e);
                return (
                  (null == t ? void 0 : t.quotedMsg) &&
                    (delete t.quotedMsg.messageSecret,
                    delete t.quotedMsg.streamingSidecar,
                    delete t.quotedMsg.mediaKey,
                    delete t.quotedMsg.mediaKeyTimestamp,
                    delete t.quotedMsg.directPath,
                    delete t.quotedMsg.filehash,
                    delete t.quotedMsg.encFilehash),
                  t
                );
              });
            return o;
      ...
      81549(e, t, r) {
        ...
        const s = r(13691),
          ...
          c = r(14647);
        u.onInjected(function () {
          const e = c.BackendEventBus.trigger.bind(c.BackendEventBus);
          c.BackendEventBus.trigger = function (t, ...r) {
            return (
              s.internalEv.emit("conn.backend_event", t, ...r),
              e(t, ...r)
            );
          };
        });
      ...
      83400(e, t, r) {
        ...
        u.onInjected(function () {
          (0, c.wrapModuleFunction)(
            l.getErrorCodeFromLogoutReason,
            (e, ...t) => {
              const [r] = t;
      ...
      28952(e, t, r) {
        ...
        const u = s(r(17833)),
          ...
          l = a(r(7222)),
          d = r(20514),
          f = (0, u.default)("WA-JS:conn:main_ready");
        l.onInjected(function () {
          const e = (t) => {
            ((e) => e === d.StreamMode.MAIN || e === d.StreamMode.QR)(t) &&
              (f("emitting conn.main_ready"),
              c.internalEv.emit("conn.main_ready"),
              c.internalEv.off("conn.stream_mode_changed", e));
          };
          c.internalEv.on("conn.stream_mode_changed", e);
        });
      },
      19516(e, t, r) {
        "use strict";
      ...
      53706(e, t, r) {
        ...
        u.onInjected(function () {
          c.Stream.mode &&
            s.internalEv.emit("conn.stream_mode_changed", c.Stream.mode);
          c.Stream.info &&
            s.internalEv.emit("conn.stream_info_changed", c.Stream.info);
          (c.Stream.on("change:mode", (e, t) => {
            s.internalEv.emit("conn.stream_mode_changed", t);
          }),
            c.Stream.on("change:info", (e, t) => {
              s.internalEv.emit("conn.stream_info_changed", t);
            }));
        });
      },
      79330(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.changeEnviromentDevice = function () {
            ((n.Enviroment.default.isWeb = !n.Enviroment.default.isWeb),
              (n.Enviroment.default.isWindows =
                !n.Enviroment.default.isWindows));
          }));
        const n = r(14647);
      },
      ...
      34618(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getABProps = function () {
            const e = s.getAllABPropConfigs();
            if (!e) return [];
            return e.map((e) =>
              Object.assign(Object.assign({}, e), {
                name: u(String(e.configCode)),
              }),
            );
          }),
          (t.getABPropsMap = function () {
            const e = s.getAllABPropsMap();
            if (!e) return new Map();
            const t = new Map();
            return (
              e.forEach((e, r) => {
        ...
        const s = a(r(35674));
        function u(e) {
          return s.getABPropConfigNameFromCode(e) || null;
        }
      },
      11102(e, t, r) {
        "use strict";
      ...
      20027(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getAutoDownloadSettings = function () {
            return {
              photos: (0, n.getAutoDownloadPhotos)(),
              audio: (0, n.getAutoDownloadAudio)(),
              videos: (0, n.getAutoDownloadVideos)(),
              documents: (0, n.getAutoDownloadDocuments)(),
            };
          }));
        const n = r(90167);
      },
      64120(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getBuildConstants = c),
          (t.isWhatsAppVersionGTE = function (e) {
            const t = c(),
              r = (null == t ? void 0 : t.VERSION_STR) || "0.0.0";
            return (0, s.compare)(r, e, ">=");
          }),
          (t.isWhatsAppVersionLTE = function (e) {
            const t = c(),
              r = (null == t ? void 0 : t.VERSION_STR) || "0.0.0";
            return (0, s.compare)(r, e, "<=");
          }));
        const s = r(38385),
          u = a(r(7222));
        function c() {
          const e = u.search((e) => e.VERSION_STR);
          return e
            ? Object.assign(Object.assign({}, e), {
                PARSED: {
                  PRIMARY: parseInt(e.VERSION_PRIMARY, 10),
                  SECONDARY: parseInt(e.VERSION_SECONDARY, 10),
                  TERTIARY: parseInt(e.VERSION_TERTIARY, 10),
                },
              })
            : null;
        }
      ...
      41900(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMigrationState = function () {
            const e = {
              isLidMigrated: !1,
              isSyncdSessionMigrated: !1,
              shouldApplyNonMigratedMessagingRules: !1,
            };
            try {
              e.isLidMigrated = (0, n.isLidMigrated)();
            } catch (e) {
              console.warn("isLidMigrated function is not available");
            }
            try {
              e.isSyncdSessionMigrated =
                o.Lid1X1MigrationUtils.isSyncdSessionMigrated();
            } catch (e) {
              console.warn("isSyncdSessionMigrated function is not available");
            }
            try {
              e.shouldApplyNonMigratedMessagingRules =
            ...
            try {
              e.currentLid = o.UserPrefs.getMaybeMeLidUser();
            } catch (e) {
              console.warn("getMaybeMeLidUser function is not available");
            }
            try {
              e.currentPn = o.UserPrefs.getMaybeMePnUser();
            } catch (e) {
      ...
      21942(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMyUserWid = function () {
            return "function" == typeof n.UserPrefs.getMaybeMeUser
              ? n.UserPrefs.getMaybeMeUser()
              : n.UserPrefs.getMaybeMePnUser();
          }));
        const n = r(14647);
      },
      13158(e, t, r) {
      ...
      37200(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.Theme = void 0),
          (t.getTheme = function () {
            const e = (0, n.getTheme)();
            return "light" === e ? o.LIGHT : "dark" === e ? o.DARK : o.LIGHT;
          }));
        const n = r(90167);
        var o;
        !(function (e) {
      ...
      60397(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setTheme =
            ...
            t.isWhatsAppVersionGTE =
            t.getBuildConstants =
            t.getAutoDownloadSettings =
            t.getAuthCode =
            t.getABPropsMap =
            t.getABProps =
            t.getABPropName =
            t.genLinkDeviceCodeForPhoneNumber =
            t.changeEnviromentDevice =
              void 0));
        var n = r(79330);
        Object.defineProperty(t, "changeEnviromentDevice", {
          enumerable: !0,
          get: function () {
        ...
        var i = r(34618);
        (Object.defineProperty(t, "getABPropName", {
          enumerable: !0,
          get: function () {
            return i.getABPropName;
          },
        }),
          Object.defineProperty(t, "getABProps", {
            enumerable: !0,
            get: function () {
              return i.getABProps;
            },
          }),
          Object.defineProperty(t, "getABPropsMap", {
            enumerable: !0,
            get: function () {
        ...
        var s = r(20027);
        Object.defineProperty(t, "getAutoDownloadSettings", {
          enumerable: !0,
          get: function () {
        ...
        var u = r(64120);
        (Object.defineProperty(t, "getBuildConstants", {
          enumerable: !0,
          get: function () {
            return u.getBuildConstants;
          },
        }),
          Object.defineProperty(t, "isWhatsAppVersionGTE", {
            enumerable: !0,
            get: function () {
        ...
        var l = r(41900);
        Object.defineProperty(t, "getMigrationState", {
          enumerable: !0,
          get: function () {
        ...
        var p = r(7379);
        Object.defineProperty(t, "getMyUserLid", {
          enumerable: !0,
          get: function () {
        ...
        var g = r(21942);
        Object.defineProperty(t, "getMyUserWid", {
          enumerable: !0,
          get: function () {
        ...
        var y = r(79229);
        Object.defineProperty(t, "getStreamData", {
          enumerable: !0,
          get: function () {
        ...
        var A = r(38871);
        Object.defineProperty(t, "setAutoDownloadSettings", {
          enumerable: !0,
          get: function () {
            return A.setAutoDownloadSettings;
          },
        });
        var T = r(22987);
        ...
        var k = r(52460);
        Object.defineProperty(t, "setTheme", {
          enumerable: !0,
          get: function () {
            return k.setTheme;
          },
      ...
      38871(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setAutoDownloadSettings = async function (e) {
            void 0 !== e.photos && s.setAutoDownloadPhotos(e.photos);
            void 0 !== e.audio && s.setAutoDownloadAudio(e.audio);
            void 0 !== e.videos && s.setAutoDownloadVideos(e.videos);
            void 0 !== e.documents && s.setAutoDownloadDocuments(e.documents);
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setLimit = function (e, t) {
            switch (e) {
              ...
              case "maxShare":
                if ("number" != typeof t)
                  throw new u.WPPError("maxShare_error", "Value type invalid!");
                return (
      ...
      52460(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setTheme = async function (e) {
            if (!Object.values(o.Theme).includes(e))
              throw new Error(
      ...
      22316(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.InvalidWidForGetPnLidEntry = void 0),
          (t.getPnLidEntry = async function (e) {
            const t = (0, i.assertWid)(e);
            let r, n, o;
            if ("c.us" !== t.server && "lid" !== t.server) throw new l(t);
            if (t.isLid())
              ((r = t), (n = s.lidPnCache.getPhoneNumber(t) || void 0));
            else if ("c.us" === t.server)
              if (((n = t), (r = s.lidPnCache.getCurrentLid(t) || void 0), r))
                c(`LID found in cache: ${r.toString()}`);
              else {
                c(
                  `LID not found in cache for ${t.toString()}, querying server...`,
                );
                const e = await (0, u.queryExists)(t);
                (null == e ? void 0 : e.lid)
                  ? ((r = e.lid),
                    c(`LID retrieved from server: ${r.toString()}`))
                  : c(`No LID returned from server for ${t.toString()}`);
              }
            const a = s.ContactStore.get(r || n || t);
            a &&
              (o = {
                name: a.name,
                ...
                syncToAddressbook: a.syncToAddressbook,
                isContactSyncCompleted: a.isContactSyncCompleted,
              });
            const d = {
              lid: r
                ? { id: r.user, server: r.server, _serialized: r.toString() }
                : void 0,
              phoneNumber: n
                ? { id: n.user, server: n.server, _serialized: n.toString() }
                : void 0,
              contact: o,
            };
            return (c(`getPnLidEntry result for ${t.toString()}`, d), d);
          }));
        const o = n(r(17833)),
          i = r(41687),
          a = r(62857),
          s = r(14647),
          u = r(53141),
          c = (0, o.default)("WA-JS:contact:getPnLidEntry");
        class l extends a.WPPError {
          constructor(e) {
            (super(
              "invalid_wid",
              `Invalid WID value for ${e} - getPnLidEntry only supports @c.us and @lid.`,
            ),
              (this.id = e));
          }
        }
      ...
      20941(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.unsubscribePresence =
            ...
            t.remove =
            t.queryWidExists =
            t.queryUsernameExists =
            t.queryExists =
            t.list =
            t.getStatus =
            t.getProfilePictureUrl =
            t.InvalidWidForGetPnLidEntry =
            t.getPnLidEntry =
            t.getCommonGroups =
        ...
        var a = r(22316);
        (Object.defineProperty(t, "getPnLidEntry", {
          enumerable: !0,
          get: function () {
            return a.getPnLidEntry;
          },
        }),
          Object.defineProperty(t, "InvalidWidForGetPnLidEntry", {
            enumerable: !0,
            get: function () {
        ...
        var d = r(42357);
        Object.defineProperty(t, "queryUsernameExists", {
          enumerable: !0,
          get: function () {
        ...
        var f = r(94349);
        Object.defineProperty(t, "queryWidExists", {
          enumerable: !0,
          get: function () {
        ...
        var g = r(46683);
        Object.defineProperty(t, "reportContact", {
          enumerable: !0,
          get: function () {
      ...
      42357(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.queryUsernameExists = async function (e, t) {
            return (0, n.queryUsernameExists)(e, t);
          }));
        const n = r(23583);
      },
      94349(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.queryWidExists = async function (e) {
            const t = (0, i.assertWid)(e);
            u("queryWidExists: %s", t.toString());
            const r = t.isLid()
                ? a.lidPnCache.getPhoneNumber(t)
                : a.lidPnCache.getCurrentLid(t),
              n = a.ContactStore.get(t),
              o = r ? a.ContactStore.get(r) : null;
            if (null != n || null != o) {
              const e = n || o;
              return (
                u("contactStore hit for %s", t.toString()),
                (function (e, t) {
                  const r = a.ApiContact.getCurrentLid(t) || void 0;
                  return {
                    wid: t,
                    biz: e.isBusiness,
                    bizInfo:
                      e.isBusiness && null != e.verifiedName
                        ? {
                            verifiedName: {
                              isApi: !!e.isEnterprise,
                        ...
                        : void 0,
                    disappearingMode:
                      null != e.disappearingModeDuration &&
                      null != e.disappearingModeSettingTimestamp
                        ? {
                            duration: e.disappearingModeDuration,
                            settingTimestamp:
                              e.disappearingModeSettingTimestamp,
                          }
                        : void 0,
                    lid: r,
                    username: e.username,
            ...
            u("contactStore miss for %s", t.toString());
            const l = `+${t.toString()}`;
            if (c.has(l))
              return (u("promise cache hit for %s", t.toString()), c.get(l));
            u("promise cache miss for %s, fetching from server", t.toString());
            const d = (async function (e) {
              u("fetchFromServer: requesting %s", e.toString());
              try {
                const t = await (0, s.queryWidExists)(e);
                if (!t)
                  return (
                    u("fetchFromServer: no result for %s", e.toString()),
                    null
                  );
                const r = a.ApiContact.getCurrentLid(e) || void 0,
                  n = {
                    wid: t.wid,
                    biz: t.biz,
                    bizInfo: t.bizInfo,
                    disappearingMode: t.disappearingMode,
                    lid: r,
                    username: t.username,
                  };
                return (
                  u("fetchFromServer: result for %s %o", e.toString(), n),
                  n
                );
              } catch (t) {
                return (
                  u("fetchFromServer: error for %s: %o", e.toString(), t),
                  null
                );
              }
            })(t)
              .then((e) => {
                const r = e ? 3e5 : 15e3;
                return (
                  u("caching result for %s, ttl=%dms", t.toString(), r),
                  setTimeout(() => c.delete(l), r),
                  e
                );
              })
        ...
        const o = n(r(17833)),
          ...
          a = r(14647),
          s = r(2571),
          u = (0, o.default)("WA-JS:contact:queryWidExists"),
          c = new Map();
      },
      75513(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.remove = async function (e) {
            e = (0, n.assertWid)(e);
            const t = await (0, s.get)(e);
            if (!t)
              throw new i.WPPError("contact_not_found", "Contact not found");
            if (!(0, a.getIsMyContact)(t))
              throw new i.WPPError(
                "number_is_not_your_contact",
                `The number ${e._serialized} is not your contact`,
              );
            if ((0, o.isWhatsAppVersionGTE)("2.3000.1030110621"))
              if (e.isLid()) {
                const r = t.username;
                await (0, a.deleteContactActionV2)({
                  lid: e.toString(),
                  username: r,
                });
              } else await (0, a.deleteContactActionV2)({ phoneNumber: e });
            else await (0, a.deleteContactAction)(e.user);
            return await (0, s.get)(e);
          }));
        const n = r(41687),
          o = r(60397),
          i = r(62857),
      ...
      46683(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.reportContact = async function (e, t = "ChatInfoReport", r) {
            var n;
            const o = (0, s.assertWid)(e),
              i = u.ChatStore.get(o) || new u.ChatModel({ id: o }),
              a = await c.reportSpam(i, t, r);
            return {
              wid: o,
              reportId:
                null === (n = a.reportIdMixin) || void 0 === n
                  ? void 0
                  : n.reportId,
      ...
      88900(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.save = async function (e, t, r) {
            ...
            void 0 !== (null == r ? void 0 : r.syncAdressBook) &&
              console.warn(
                '[WPPConnect Warning] The "syncAdressBook" option is deprecated due to a typo. Please use "syncAddressBook" instead.',
              );
            const p = (0, n.assertWid)(e),
              g = a.ApiContact.getAlternateUserWid(p),
              m = p.isLid()
                ? p.user
                : (null == g ? void 0 : g.isLid())
                  ? g.user
                  : null,
              y =
                "c.us" === p.server
              ...
              v =
                null ===
                  (l =
                    null !== (c = null == r ? void 0 : r.syncAddressBook) &&
                    void 0 !== c
                      ? c
                      : null == r
                        ? void 0
              ...
              b =
                null !==
                  (f =
                    null !== (d = null == r ? void 0 : r.lastName) &&
                    void 0 !== d
                      ? d
                      : null == r
                        ? void 0
                  ...
                  ? f
                  : "";
            if ((0, o.isWhatsAppVersionGTE)("2.3000.1030209354"))
              await (0, s.saveContactActionV2)({
                phoneNumber: y,
              ...
              await (0, s.saveContactAction)(y, null, null, null, t, b, v);
            }
            return await (0, u.get)(e);
          }));
        const n = r(41687),
          o = r(60397),
          i = r(62857),
          ...
          (t.subscribePresence = async function (e) {
            ...
            for (const r of e)
              try {
                ...
                if (
                  (o.subscribeGroupPresence && e.isGroup()
                    ? (0, o.subscribeGroupPresence)(e)
                    : await (0, o.subscribePresence)(e),
                  n.PresenceStore.get(e))
                ) {
                  t.push(e);
                  continue;
                }
      ...
      54409(e, t, r) {
        ...
        s.onInjected(function () {
          const e = {
            ...
            isUser: (e) => () => e.id.isUser(),
            isGroup: (e) => () => e.id.isGroup(),
            isBroadcast: (e) => () => e.id.isBroadcast(),
            isPSA: (e) => () => e.id.isPSA(),
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.create = async function (e, t, r) {
            ...
            for (const e of o) {
              ...
              const t = f.ContactStore.get(e);
              if (t) {
                a.push(t.id);
                continue;
              }
              const r = await l.queryExists(e);
              if (!r)
                throw new d.WPPError(
            ...
            const g = r ? (0, s.assertWid)(r) : void 0,
              m = await p.sendCreateGroup(e, a, void 0, g);
            if (m.gid) {
              const e = await u.find(m.gid);
              !1 !==
      ...
      45195(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getGroupInfoFromInviteCode = async function (e) {
            ...
            const s =
              null ===
                (t = await (0, o.sendQueryGroupInvite)(e).catch(() => null)) ||
              void 0 === t
                ? void 0
                : t.groupInfo;
            if (!s)
            ...
            return Object.assign(Object.assign({}, s), {
              descOwner:
                null === (r = s.descOwner) || void 0 === r
                  ? void 0
                  : r.toString(),
              id: s.id.toString(),
              owner:
                null === (i = s.owner) || void 0 === i ? void 0 : i.toString(),
              participants: s.participants.map((e) =>
                Object.assign(Object.assign({}, e), { id: e.id.toString() }),
              ),
              subjectOwner:
                null === (a = s.subjectOwner) || void 0 === a
                  ? void 0
                  : a.toString(),
            });
          }));
      ...
      84784(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.join = async function (e) {
            ...
            try {
              const t = await (0, n.sendJoinGroupViaInvite)(e);
              return {
                id: t.gid.toString(),
                pendingApproval: t.membershipApprovalMode,
              };
            } catch (e) {
              if (
                e instanceof Error &&
                (function (e) {
                  return (
                    "UnexpectedJoinGroupViaInviteResponse" === e.name &&
                    "gid" in e &&
                    "membershipApprovalMode" in e
                  );
                })(e)
              )
                return {
                  id: e.gid.toString(),
                  pendingApproval: e.membershipApprovalMode,
                };
              throw e;
            }
          }));
      ...
      28156(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.version =
            ...
            t.isFullReady =
              void 0),
          (t.license = t.supportedWhatsappWeb = void 0),
          r(91491),
          r(80687),
          r(22418));
        const s = a(r(7222));
      ...
      56802(e, t) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessagesFromRowId = async function (e) {
            const { minRowId: t, limit: r = 1e3 } = e;
            if ("number" != typeof t)
            ...
            if (-1 !== r && r <= 0)
              throw new Error(
                "limit must be either -1 (unlimited) or a positive number",
              );
      ...
      72355(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMessagesFromRowId = void 0));
        var n = r(56802);
        Object.defineProperty(t, "getMessagesFromRowId", {
          enumerable: !0,
          get: function () {
      ...
      60513(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }), o(r(72355), t));
      },
      4475(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
      ...
      75228(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.addChats = async function (e, t) {
            if (0 === t.length) return;
            if (!i.LabelStore.get(e))
              throw new o.WPPError("list_not_found", `List ${e} not found`, {
                id: e,
              });
            const r = t.map((e) => (0, n.assertGetChat)(e));
            await i.LabelStore.addOrRemoveLabels([{ id: e, type: "add" }], r);
          }));
        const n = r(41687),
          o = r(62857),
          i = r(14647);
      ...
      63886(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.create = async function (e, t = [], r) {
            ...
            if (void 0 !== r && (!Number.isInteger(r) || r < 0))
              throw new o.WPPError(
                "list_invalid_color",
            ...
            const u =
                void 0 !== r
                  ? r
                  : null !== (s = await i.LabelStore.getNextAvailableColor()) &&
                      void 0 !== s
                    ? s
                    : 0,
              c = await (0, a.getNextLabelId)();
            if ((await (0, a.labelAddAction)(e.trim(), u), t.length > 0)) {
              const e = t.map((e) => (0, n.assertGetChat)(e));
              await i.LabelStore.addOrRemoveLabels(
                [{ id: String(c), type: "add" }],
                e,
              );
            }
            return String(c);
      ...
      88204(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.rename =
            ...
            t.addChats =
              void 0));
        var n = r(75228);
        Object.defineProperty(t, "addChats", {
          enumerable: !0,
          get: function () {
            return n.addChats;
          },
        ...
        var s = r(46131);
        Object.defineProperty(t, "removeChats", {
          enumerable: !0,
          get: function () {
        ...
        var u = r(55388);
        Object.defineProperty(t, "rename", {
          enumerable: !0,
          get: function () {
            return u.rename;
          },
      ...
      87790(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.list = function () {
            return n.LabelStore.getModelsArray()
              .filter((e) => 5 === e.type)
              .map((e) => {
                var t;
                return {
                  ...
                  name: e.name,
                  colorIndex:
                    null !== (t = e.colorIndex) && void 0 !== t ? t : 0,
                };
              });
          }));
        const n = r(14647);
      ...
      31034(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.remove = async function (e) {
            var t;
            const r = o.LabelStore.get(e);
            if (!r)
              throw new n.WPPError("list_not_found", `List ${e} not found`, {
                id: e,
              });
            await (0, i.labelDeleteAction)(
              e,
              r.name,
              null !== (t = r.colorIndex) && void 0 !== t ? t : 0,
            );
          }));
        const n = r(62857),
          o = r(14647),
      ...
      46131(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.removeChats = async function (e, t) {
            if (0 === t.length) return;
            if (!i.LabelStore.get(e))
              throw new o.WPPError("list_not_found", `List ${e} not found`, {
                id: e,
      ...
      55388(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.rename = async function (e, t) {
            ...
            const s = o.LabelStore.get(e);
            if (!s)
              throw new n.WPPError("list_not_found", `List ${e} not found`, {
                id: e,
              });
            await (0, i.labelEditAction)(
              e,
              t.trim(),
              null !== (r = s.predefinedId) && void 0 !== r ? r : 0,
              null !== (a = s.colorIndex) && void 0 !== a ? a : 0,
            );
          }));
        const n = r(62857),
          o = r(14647),
      ...
      22086(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }), o(r(88204), t));
      },
      22769(e, t) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.IGNORE_FAIL_MODULES = t.META_MODULE_ID_BLACKLIST = void 0),
          (t.META_MODULE_ID_BLACKLIST = new Set([
            "WAWebEmojiPanelContentEmojiSearchEmpty.react",
            "WAWebMoment-es-do",
          ])),
          (t.IGNORE_FAIL_MODULES = new Set([
            "revokeStatus",
      ...
      7222(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
              ...
              const r = () => {
                "unknown" === t.loaderType &&
                  ...
                  (async function (e) {
                    ...
                    ((t.loaderType = "meta"),
                      (t.moduleRequire = function (t) {
                        try {
                          return (
                            e.ErrorGuard.skipGuardGlobal(!0),
                            e.importNamespace(t)
                          );
                        } catch (e) {}
                        return null;
                      }),
                      Object.defineProperty(t.moduleRequire, "m", {
                        get: () =>
                          (function () {
                            var e;
                            const r = (0, t.__debug)().modulesMap,
                              n = Object.keys(r);
                            if (l && n.length === d) return l;
                            const o = {};
                            for (const t of n)
                              /^(?:use)?WA/.test(t) &&
                                !a.META_MODULE_ID_BLACKLIST.has(t) &&
                                (o[t] =
                                  null === (e = r[t]) || void 0 === e
                                    ? void 0
                                    : e.factory);
                            return ((l = o), (d = n.length), o);
                          })(),
                      }),
                      (t.isInjected = !0),
                      s("injected"),
                      await i.internalEv
                        .emitAsync("loader.injected")
                        .catch(() => null),
                      await u);
                    (await (async function (
                      ...
                      { timeout: 5e3, initialDelay: 25, maxDelay: 250 },
                    )) ||
                      s(
                        "meta loader: core module not resolvable within 5s, continuing",
                      );
                    ((t.isReady = !0),
                      s("ready to use"),
                      await i.internalEv
                        .emitAsync("loader.ready")
                        .catch(() => null),
                      window.wppForceMainLoad
                        ? (s("wppForceMainLoad is set, waiting 5 seconds"),
                          await new Promise((e) => setTimeout(e, 5e3)))
                        : (s("waiting main ready"), await c));
                    ((t.isFullReady = !0),
                      s("full ready to use"),
                      await i.internalEv
                        .emitAsync("loader.full_ready")
                        .catch(() => null));
                  })(e);
              };
              if (e.require && e.__d) return void r();
              const n = (t) => {
                  const n = Object.getOwnPropertyDescriptor(e, t);
                  if (n && !1 === n.configurable) return !1;
                  let o = null == n ? void 0 : n.value;
                  try {
                    return (
                      Object.defineProperty(e, t, {
                        configurable: !0,
                ...
                f = n("require"),
                p = setInterval(() => {
                  "unknown" === t.loaderType ? r() : clearInterval(p);
                }, 250);
              (setTimeout(() => clearInterval(p), 6e4),
                (o && f) ||
                  s(
                    "meta loader: setter trap unavailable, relying on fallback poll",
                  ));
            })(e);
            const r = "webpackChunkwhatsapp_web_client",
              n = e[r] || [];
                ...
                ((t.moduleRequire = e),
                  queueMicrotask(() =>
                    (async (e) => {
                      ...
                      for (const e of n)
                        try {
                          await t.moduleRequire.e(e);
                        } catch (r) {
                          s("load file error", t.moduleRequire.u(e));
                        }
                      ((t.isReady = !0),
                        s("ready to use"),
                        await i.internalEv
                          .emitAsync("loader.ready")
                          .catch(() => null),
                        s("wppForceMainLoad", window.wppForceMainLoad),
                        window.wppForceMainLoad
                          ? await new Promise((e) => setTimeout(e, 5e3))
                          : await c,
                        s("loading full runtime files"));
                      for (const e of r)
                        try {
                          await t.moduleRequire.e(e);
                        } catch (r) {
          ...
          (t.modules = function (e, r = !1) {
            const n = {};
            let o = Object.keys(t.moduleRequire.m);
            r && (o = o.reverse());
            for (const r of o)
              if ("webpack" !== t.loaderType || !h(r))
                try {
                  const o = j(r);
                  if ("webpack" !== t.loaderType && b(r, o)) continue;
                  (e && !e(o, r)) || (n[r] = o);
                } catch (e) {
                  continue;
                }
            return (
              s(
                `${Object.keys(n).length} modules found with: ${null == e ? void 0 : e.toString()}`,
              ),
              n
            );
          }),
        ...
        ((t.__debug = () => (self || window).require("__debug")),
          (t.fallbackModules = {}));
        const u = i.internalEv.waitFor("conn.main_init"),
          c = i.internalEv.waitFor("conn.main_ready");
        let l = null,
          d = -1;
        const f = new Map();
        function p(e) {
          if ("webpack" !== t.loaderType) return "";
          if (!t.moduleRequire.m[e]) return "";
          if (f.has(e)) return f.get(e);
          const r = t.moduleRequire.m[e].toString();
          return (f.set(e, r), r);
        }
        const g = new Map();
        let m = null;
        function y(e) {
          ...
          const r = (function () {
              ...
              if (!m)
                try {
                  m =
                    null === (r = (e = self).require) || void 0 === r
                      ? void 0
                      : r.call(e, "react");
                } catch (e) {}
              return m;
            ...
            n = [
              e,
              e.default,
              ...("object" == typeof e ? Object.values(e) : []),
            ];
          for (const e of n)
            if (e) {
              if ("object" == typeof e && e.$$typeof) return !0;
              if (
                r &&
                "function" == typeof e &&
                e.prototype &&
                ((r.Component && e.prototype instanceof r.Component) ||
                  (r.PureComponent && e.prototype instanceof r.PureComponent))
              )
                return !0;
            }
          return !1;
        ...
        function w(e) {
          const r = Object.keys(t.moduleRequire.m);
          if (e instanceof RegExp) return r.filter((t) => e.test(t));
          const n = (function () {
              const e = Object.keys(t.moduleRequire.m);
              if (_ && e.length === P) return _;
              const r = new Map();
              for (const t of e)
                for (const e of M(t)) {
                  let n = r.get(e);
          ...
          for (const e of o) {
            ...
            if (i) {
              const e = new Set(t);
              if (((i = i.filter((t) => e.has(t))), !i.length)) return [];
            } else i = t.slice();
          }
          return i || [];
        }
        function O(e, r = !1, n) {
          ...
          const o = Object.keys(t.moduleRequire.m),
            i = r ? o.slice().reverse() : o;
          let a;
          if (n) {
            const e = w(n);
            if (e.length) {
              ...
              a = r
                ? e
                    .slice()
                    .reverse()
                    .concat(i.filter((e) => !t.has(e)))
                : e.concat(i.filter((e) => !t.has(e)));
            } else a = i;
          } else a = i;
          const u = setTimeout(() => {
          ...
          for (const r of a)
            if ("webpack" !== t.loaderType || !h(r))
              try {
                const n = (0, t.moduleRequire)(r);
                if ("webpack" !== t.loaderType && b(r, n)) continue;
                if (e(n, r))
                  return (
          ...
          const c = Object.keys(t.fallbackModules);
          for (const r of c)
            try {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.create = async function (e, t) {
            ...
            return {
              ...
              inviteLink: `https://whatsapp.com/channel/${null == u ? void 0 : u.newsletterInviteLinkMetadataMixin.inviteCode}`,
              name:
                null ===
      ...
      25578(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.edit = async function (e, t) {
            ...
            if (null == t ? void 0 : t.picture) {
              let e = t.picture;
              t.picture.includes("http") &&
                ({ data: e } = await (0, n.downloadImage)(
                  null == t ? void 0 : t.picture,
                  "image/jpeg",
                ));
              const r = await (0, n.convertToFile)(e),
                o = await (0, n.resizeImage)(r, {
                  width: 640,
                  height: 640,
                  mimeType: "image/jpeg",
                  resize: "cover",
                });
              l = await (0, n.blobToBase64)(o);
            }
            ...
            return {
              ...
              inviteLink: `https://whatsapp.com/channel/${null == d ? void 0 : d.newsletterInviteLinkMetadataMixin.inviteCode}`,
              name:
                null ===
      ...
      94523(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.follow = async function (e) {
            ...
            try {
              return (await (0, o.mexJoinNewsletter)(e), !0);
            } catch (e) {
              if (419 === e.status)
                throw new n.WPPError(
              ...
              throw new n.WPPError(
                ...
                `Failed to follow newsletter: ${e.message}`,
                { error: e },
              );
            }
          }));
      ...
      48812(e, t, r) {
        ...
        var a = r(94523);
        Object.defineProperty(t, "follow", {
          enumerable: !0,
          get: function () {
            return a.follow;
          },
        ...
        var l = r(17956);
        Object.defineProperty(t, "unfollow", {
          enumerable: !0,
          get: function () {
            return l.unfollow;
          },
      ...
      7071(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.mute = async function (e, t) {
            var r;
            const u = await (0, s.ensureNewsletter)(e);
            if (null != t && "boolean" != typeof t)
              throw new n.WPPError(
                "invalid_mute_value",
                "Mute value must be boolean",
              );
            const c =
                null !==
                  (r =
                    null === i.CHANNEL_EVENT_SURFACE ||
                    void 0 === i.CHANNEL_EVENT_SURFACE
                      ? void 0
                      : i.CHANNEL_EVENT_SURFACE.CHANNEL_UPDATES_HOME) &&
                void 0 !== r
                  ? r
                  : 1,
              l = !1 === t ? 0 : -1;
            a.toggleNewsletterAdminActivityMuteStateAction
              ? await (0, a.toggleNewsletterAdminActivityMuteStateAction)(
                  u.id,
                  l,
                  { eventSurface: c },
                )
              : !1 === t
                ? await (0, a.unmuteNewsletter)([e])
                : await (0, a.muteNewsletter)([e]);
            return o.NewsletterStore.get(e);
          }));
        const n = r(62857),
          o = r(14647),
          i = r(20514),
          ...
          (t.search = async function (e, t) {
            ...
            try {
              const r = {
                  ...
                  limit: (null == t ? void 0 : t.limit) || 20,
                  cursorToken: null == t ? void 0 : t.cursorToken,
                },
                n = await (0, o.mexFetchNewsletterDirectorySearchResults)(r),
                i = null == n ? void 0 : n.xwa2_newsletters_directory_search,
                a = (null == i ? void 0 : i.result) || [],
                s = null == i ? void 0 : i.page_info;
              return {
                newsletters: a.map((e) => {
                  var t, r, n;
                  const o = e.thread_metadata || {};
                  let i = 0;
                  if (o.subscribers_count) {
                    const e = parseInt(o.subscribers_count, 10);
                    i = isNaN(e) ? 0 : e;
                  }
                  let a = 0;
                  if (o.creation_time) {
                    const e = parseInt(o.creation_time, 10);
                    a = isNaN(e) ? 0 : e;
                  }
                  return {
                    idJid: e.idJid || e.id || "",
                ...
                pageInfo: s
                  ? { hasNextPage: s.has_next_page, endCursor: s.end_cursor }
                  : void 0,
              };
            } catch (e) {
              throw new n.WPPError(
                "newsletter_search_failed",
                `Failed to search newsletters: ${e.message}`,
                { error: e },
              );
            }
          }));
      ...
      17956(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.unfollow = async function (e) {
            ...
            try {
              return (await (0, o.mexLeaveNewsletter)(e), !0);
            } catch (e) {
              if (400 === e.status) return !0;
              throw new n.WPPError(
                "newsletter_unfollow_failed",
                `Failed to unfollow newsletter: ${e.message}`,
                { error: e },
              );
            }
          }));
        ...
        u.onInjected(() => {
          c.MsgStore.on("add", (e) => {
            ...
            const i = JSON.parse(
              null ===
                (o =
                  null === (n = e.interactivePayload) || void 0 === n
                    ? void 0
                    : n.buttons[0]) || void 0 === o
                ? void 0
                : o.buttonParamsJson,
            );
            queueMicrotask(() => {
      ...
      80369(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.accept = async function (e) {
            const { msgId: t } = e,
              r = i.MsgStore.get(t);
            if (!r) throw new o.WPPError("msg_not_found", "Message not found");
            if (r.type !== a.MSG_TYPE.ORDER)
              throw new o.WPPError("msg_not_order", "Message is not an order");
            if (!r.orderId || !r.token)
              throw new o.WPPError(
            ...
            const d = await (0, s.queryOrder)(r.orderId, 80, 80, r.token),
              f = {
                items: d.products.map((e) => ({
                  id: e.id.toString(),
                  name: e.name,
                  amount: e.price || 0,
            ...
            ((0, s.updateMessageTable)(r.id, {
              status: u.OrderMessageStatus.ACCEPTED,
            }),
              r.set({ status: u.OrderMessageStatus.ACCEPTED }));
            const p = {
                reference_id: r.orderId,
                type: "physical-goods",
                payment_configuration: "merchant_categorization_code",
                currency: d.currency,
                total_amount: { value: f.totalAmount, offset: 1e3 },
                order_type: "ORDER",
                order: {
                  status: "payment_requested",
                  items: f.items.map((e) => ({
                    retailer_id: e.id,
                    name: e.name,
                    amount: { value: e.amount, offset: 1e3 },
                    quantity: e.quantity,
                    isCustomItem: e.isCustomItem || !1,
                    isQuantitySet: e.isQuantitySet || !0,
                  })),
                  subtotal: { value: f.subtotal, offset: 1e3 },
                  tax: f.tax ? { value: f.tax, offset: 1e3 } : null,
                },
              },
              g = {
                type: "interactive",
            ...
            await (0, n.sendRawMessage)(c.id, g, { quotedMsg: r });
          }));
        const n = r(97829),
          o = r(62857),
          i = r(14647),
      ...
      21747(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.decline = async function (e) {
            const { msgId: t, declineNote: r } = e,
              c = i.MsgStore.get(t);
            if (!c) throw new o.WPPError("msg_not_found", "Message not found");
            if (c.type !== a.MSG_TYPE.ORDER)
              throw new o.WPPError("msg_not_order", "Message is not an order");
            if (!c.orderId || !c.token)
              throw new o.WPPError(
                "invalid_order_message",
                "Message is missing orderId or token",
              );
            ...
            const f = await (0, s.queryOrder)(c.orderId, 80, 80, c.token),
              p = {
                items: f.products.map((e) => ({
                  id: e.id.toString(),
                  name: e.name,
                  amount: e.price || 0,
                  quantity: e.quantity || 1,
              ...
              g = c.msgContextInfo(l.id);
            ((0, s.updateMessageTable)(c.id, {
              status: u.OrderMessageStatus.DECLINED,
            }),
              c.set({ status: u.OrderMessageStatus.DECLINED }),
              await (0, s.sendOrderStatusMessageAsMerchant)({
                chat: l,
                sellerJid: d,
                orderInfo: p,
                orderNote: r,
                orderStatus: u.OrderStatus.Canceled,
                offset: 2,
            ...
            const m = {
                ...
                payment_configuration: "merchant_categorization_code",
                currency: f.currency,
                total_amount: { value: p.totalAmount, offset: 1e3 },
                order_type: "ORDER",
                order: {
                  status: "canceled",
                  items: p.items.map((e) => ({
                  ...
                  subtotal: { value: p.subtotal, offset: 1e3 },
                  tax: p.tax ? { value: p.tax, offset: 1e3 } : null,
                },
              },
              y = {
                type: "interactive",
      ...
      18165(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.update = t.get = t.decline = t.accept = void 0));
        var n = r(80369);
        Object.defineProperty(t, "accept", {
          enumerable: !0,
          get: function () {
        ...
        var o = r(21747);
        Object.defineProperty(t, "decline", {
          enumerable: !0,
          get: function () {
            return o.decline;
          },
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.update = async function (e) {
            const {
                ...
                offset: c = 2,
                referenceId: l,
                paymentStatus: d = s.PaymentStatus.Pending,
                paymentMethod: f,
              } = e,
              p = o.MsgStore.get(t);
            if (!p) throw new n.WPPError("msg_not_found", "Message not found");
            if (p.type !== i.MSG_TYPE.ORDER)
              throw new n.WPPError("msg_not_order", "Message is not an order");
            if (
              p.status !== s.OrderMessageStatus.ACCEPTED &&
              p.status !== s.OrderMessageStatus.DECLINED
            )
              throw new n.WPPError(
                "order_not_processed",
            ...
            const y = await (0, a.queryOrder)(p.orderId, 80, 80, p.token),
              v = {
                items: y.products.map((e) => ({
                  id: e.id.toString(),
                  name: e.name,
                  amount: e.price || 0,
                  quantity: e.quantity || 1,
                ...
                totalAmount: y.total || 0,
                subtotal: y.subtotal || 0,
                tax: y.tax || void 0,
                currency: y.currency,
                referenceId: l || p.orderId,
              },
              b = p.msgContextInfo(g.id);
            await (0, a.sendOrderStatusMessageAsMerchant)({
              chat: g,
              sellerJid: m,
              orderInfo: v,
              orderNote: u,
      ...
      60738(e, t) {
        ...
        var r, n, o;
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.OrderMessageStatus = t.PaymentStatus = t.OrderStatus = void 0),
          (function (e) {
            ((e.Pending = "pending"),
              (e.Processing = "processing"),
              (e.PartiallyShipped = "partially_shipped"),
              (e.Shipped = "shipped"),
              (e.Complete = "completed"),
              (e.Canceled = "canceled"),
              (e.PaymentRequested = "payment_requested"),
              (e.PreparingToShip = "preparing_to_ship"),
      ...
      40923(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.editBusinessProfile = async function (e) {
            ...
            e.website &&
              Array.isArray(e.website) &&
              (e.website = e.website.map((e) => ({ url: e })));
            await (0, a.editBusinessProfile)(e);
            const t = (0, n.getMyUserWid)();
      ...
      82807(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMyProfilePicture = async function () {
            const e = (0, n.getMyUserWid)();
            return await o.ProfilePicThumbStore.find(e);
          }));
        const n = r(21942),
          o = r(14647);
      },
      ...
      95333(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.removeMyProfilePicture = async function () {
            return (
              200 ===
              (await o.functions.requestDeletePicture((0, n.getMyUserWid)()))
                .status
            );
          }));
        const n = r(21942),
      ...
      20059(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setMyProfilePicture = async function (e) {
            const t = await (0, o.convertToFile)(e),
              r = await (0, o.resizeImage)(t, {
                width: 96,
                height: 96,
                mimeType: "image/jpeg",
                resize: "cover",
              }),
              a = await (0, o.resizeImage)(t, {
                width: 640,
                height: 640,
                mimeType: "image/jpeg",
                resize: "cover",
              }),
              s = await (0, o.blobToBase64)(r),
              u = await (0, o.blobToBase64)(a);
      ...
      48736(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.setMyStatus = async function (e) {
            await c.setMyStatus(e);
            const t = await u.StatusStore.find((0, s.getMyUserWid)());
            t && (t.status = e);
            return !0;
          }));
        const s = r(21942),
      ...
      93809(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.getMyStatus = async function () {
            let e = o.StatusV3Store.getMyStatus();
            e || (e = await o.StatusV3Store.find((0, n.getMyUserWid)()));
            return e;
          }));
        const n = r(21942),
          o = r(14647);
            ...
            try {
              return (
                await (0, a.revokeStatus)(
                  i.StatusV3Store.get(i.UserPrefs.getMaybeMePnUser()),
                  t,
                ),
                !0
              );
      ...
      2700(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendImageStatus = async function (e, t = {}) {
            ...
            t = Object.assign(
              Object.assign(Object.assign({}, u.defaultSendStatusOptions), {
                messageId: c,
              }),
              t,
            );
            return await (0, o.sendFileMessage)(
              "status@broadcast",
              e,
              Object.assign(Object.assign({}, t), { type: "image" }),
            );
          }));
        const n = r(41687),
          o = r(74023),
      ...
      71459(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendRawStatus = async function (e, t = {}) {
            ...
            ((t = Object.assign(
              Object.assign(Object.assign({}, g.defaultSendStatusOptions), {
                messageId: n,
              }),
              t,
            )),
              (e.author = r));
            const o = await u.sendRawMessage(
              "status@broadcast",
              e,
              Object.assign({}, t),
            );
            return ((0, m.postSendStatus)(o), o);
          }));
        const s = r(41687),
          u = a(r(74023)),
          c = r(21942),
          ...
          m = r(28227);
        (l.onInjected(() => {
          ((0, f.wrapModuleFunction)(p.createMsgProtobuf, (e, ...t) => {
            const [r] = t,
              n = e(...t);
            return (
            ...
            (0, f.wrapModuleFunction)(p.encryptAndSendMsg, async (e, ...t) => {
              var r;
              const [n, o] = t;
              if (
                "status@broadcast" ==
                ...
                const e = (0, p.createMsgProtobuf)(n.data);
                try {
                  return (
                    await (0, p.encryptAndSendStatusMsg)(n, e, o),
                    {
                      t: n.data.t,
                      sync: null,
                      phash: null,
          ...
          l.onFullReady(() => {
            ((0, f.wrapModuleFunction)(p.getABPropConfigValue, (e, ...t) => {
              const [r] = t;
              switch (r) {
              ...
              (0, f.wrapModuleFunction)(p.primaryFeatureEnabled, (e, ...t) => {
                const [r] = t;
                switch (r) {
                  case "post_status_in_companion":
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.sendVideoStatus = async function (e, t = {}) {
            ...
            return await (0, o.sendFileMessage)(
              "status@broadcast",
              e,
              Object.assign(Object.assign({}, t), { type: "video" }),
            );
          }));
        const n = r(41687),
          o = r(74023),
      ...
      45218(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.updateParticipants = async function (e) {
            ...
            const r = (0, i.getMyUserWid)();
            (e && 0 !== e.length) ||
              ((e = a.ContactStore.getModelsArray()
                .filter((e) => e.isMyContact && !e.isContactBlocked)
                .filter((e) => e.notifyName && !e.isMe)
                .filter((e) => !e.id.equals(r))
                .map((e) => e.id)),
              (t = "contacts"));
            const s = e.map(n.assertWid).filter((e) => !e.equals(r));
            o.config.sendStatusToDevice && s.push(r);
            const u = s.map(
                (e) =>
                  new a.ParticipantModel({
                    id: e,
                    isAdmin: !1,
                    isSuperAdmin: !1,
                  }),
              ),
              c = a.WidFactory.createWid("status@broadcast");
            (await a.functions.updateParticipants({
              group: c,
              participants: u,
              version: Date.now(),
              isOffline: !1,
      ...
      39681(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.convertToFile = async function (e, t, r) {
            ...
            let n = null;
            if ("string" == typeof e && (0, a.isUrl)(e)) {
              ...
              t || (t = r.contentType);
              const o = r.toBuffer();
              n = new Blob([Uint8Array.from(o)], { type: t });
            } else n = e;
            if (!r || !t) {
      ...
      13257(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.createWid = function (e) {
            if (!e) return;
            const t = o();
            if (t && t.isWidlike && t.isWidlike(e))
              return t.createWidFromWidLike(e);
            e &&
              "object" == typeof e &&
            ...
            e &&
              "object" == typeof e &&
              "string" == typeof e._serialized &&
              (e = e._serialized);
            if ("string" != typeof e) return;
            if (/@\w*lid\b/.test(e)) return i(e, "lid");
            if (/^\d+$/.test(e)) return i(e, "c.us");
            if (/^\d+-\d+$/.test(e)) return i(e, "g.us");
            if (/status$/.test(e)) return i(e, "broadcast");
            if (t && "function" == typeof t.createWid) return t.createWid(e);
            return;
          }));
        const n = r(14647);
        function o() {
          return void 0 !== n.WidFactory && n.WidFactory
            ? n.WidFactory
            : "undefined" != typeof globalThis && globalThis.WidFactory
              ? globalThis.WidFactory
              : void 0;
        }
        const i = (e, t) => {
          const r = o();
          if (r)
            return "function" == typeof r.createUserWidOrThrow
              ? r.createUserWidOrThrow(e, t)
              : "function" == typeof r.createUserWid
                ? r.createUserWid(e, t)
                : "function" == typeof r.createWid
                  ? r.createWid(t ? `${e}@${t}` : e)
                  : void 0;
        };
      },
            ...
            return new Promise((t, r) => {
              ...
              ((n.crossOrigin = "anonymous"),
                ...
                (n.onload = function () {
                  ...
                  for (let e = 0, t = 0; e < o.length; e += 4)
                    ((i[t++] = o[e]), (i[t++] = o[e + 1]), (i[t++] = o[e + 2]));
                  let a = BigInt(0);
                  for (let e = 0; e < 8; e++)
                    a = (a << BigInt(8)) + BigInt(i[e]);
                  const s = Number(a);
                  t(i.subarray(8, 8 + s));
                }));
            });
      ...
      21294(e, t) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.getMediaTypeForValidation = function (e, t) {
            if (e && "auto-detect" !== e) return e;
      ...
      73113(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.generateThumbnailLinkPreviewData = async function (e) {
            if (g[e])
              return (l("Thumb for link preview found in cache.", e), g[e]);
            if (!d[0]) return null;
            const t = d[0];
            ...
            const o = await (function (e) {
              ...
              m =
                ...
                { key: a.Base64.encodeB64(p), timestamp: (0, s.unixTime)() }),
              y = new AbortController(),
              v = await (0, s.uploadThumbnail)({
                thumbnail: c,
      ...
      31617(e, t) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.toArrayBuffer = function (e) {
            ...
            return new Uint8Array(e).slice().buffer;
          }));
      },
      59036(e, t) {
        "use strict";
      ...
      83573(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          {
            ButtonCollection: [
              "ButtonCollectionImpl",
              "ButtonCollection",
              "default",
            ],
          },
          (e, t) =>
            "WAWebButtonCollection" === t ||
            !(!e.ButtonCollectionImpl && !e.ButtonCollection),
        );
      },
      96993(e, t, r) {
        "use strict";
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (function (e) {
            ((e.QR = "QR"),
              ...
              (e.OFFLINE = "OFFLINE"),
              (e.CONFLICT = "CONFLICT"),
              (e.PROXYBLOCK = "PROXYBLOCK"),
              (e.TOS_BLOCK = "TOS_BLOCK"),
              (e.SMB_TOS_BLOCK = "SMB_TOS_BLOCK"),
              (e.DEPRECATED_VERSION = "DEPRECATED_VERSION"));
          })(r || (t.StreamMode = r = {})));
      },
      20514(e, t, r) {
        "use strict";
      ...
      54993(e, t, r) {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.wrapModuleFunction = function (e, r) {
            ...
            g.extend("wrap")(`Wrapping '${i} for module ${n}'`);
            const a = i.split("."),
              s = a.pop();
            if (!s) {
            ...
            u[s] =
              "getShouldAppearInList" == s
                ...
                : (0, p.wrapFunction)(e.bind(u), r);
            (y.set(u[s], n), v.set(u[s], i));
          }));
        const u = s(r(17833)),
          c = r(43859),
          l = r(22418),
      ...
      35674(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.getAllABPropConfigs && e.getABPropConfigNameFromCode,
        );
      },
      72116(e, t, r) {
        "use strict";
      ...
      90722(e, t, r) {
        "use strict";
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          (t.callGetSearchContext = function (e, t) {
            if (1 === n.getSearchContext.length)
              return (0, n.getSearchContext)({ chat: e, msgKey: t });
            return (0, n.getSearchContext)(e, t);
          }));
        const n = r(73890);
      },
      29697(e, t, r) {
      ...
      40581(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.canSaveAsMyContact || e.canSaveAsMyContacts,
        );
      },
      4525(e, t, r) {
        "use strict";
      ...
      37300(e, t, r) {
        ...
        ((0, n.exportModule)(
          ...
          (e) => e.getNotifyName && e.getIsMe && e.getUserid,
        ),
          (0, n.exportModule)(
            t,
            {
            ...
            (e) => e.getPhoneNumber && e.getTextStatusString && e.getPnForLid,
          ),
          (0, n.exportModule)(
            t,
            {
              getIsMyContact: "getIsMyContact",
              getMentionName: ["getMentionName", "getFormattedShortName"],
            },
            (e) => e.getIsMyContact,
          ),
          (0, n.exportModule)(
            ...
            (e) => e.getSearchVerifiedName && e.getHeader,
          ));
      },
      46915(e, t, r) {
        "use strict";
      ...
      97718(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.createGroup && e.GroupAlreadyExistsError,
        );
      },
      7967(e, t, r) {
        "use strict";
      ...
      43520(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.getPhoneLangPref && e.setPhoneLangPref,
        );
      },
      72216(e, t, r) {
        "use strict";
      ...
      2931(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            e.Lid1X1MigrationUtils &&
            "function" == typeof e.Lid1X1MigrationUtils.isLidMigrated,
        );
      },
      1009(e, t, r) {
        "use strict";
      ...
      89791(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.mexFetchNewsletterDirectorySearchResults,
        );
      },
      7016(e, t, r) {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          t,
          { mexJoinNewsletter: "mexJoinNewsletter" },
          (e) => e.mexJoinNewsletter,
        );
      },
      97591(e, t, r) {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          t,
          { mexLeaveNewsletter: "mexLeaveNewsletter" },
          (e) => e.mexLeaveNewsletter,
        );
      },
      43002(e, t, r) {
        "use strict";
      ...
      2057(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.msgFindByDirection && e.msgFindBefore && e.msgFindAfter,
        );
      },
      68593(e, t, r) {
        "use strict";
      ...
      76030(e, t, r) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { sendClear: "sendClear" }, (e) => {
          var t, r;
          return (
            e.sendClear &&
            (null ===
              (r =
                null === (t = e.sendClear) || void 0 === t
                  ? void 0
                  : t.toString()) || void 0 === r
              ? void 0
              : r.includes("WAWebStateUtils"))
          );
        });
      },
      72110(e, t, r) {
        ...
        ((0, c.exportModule)(
          ...
          u.injectFallbackModule("sendCreateGroup", {
            sendCreateGroup: async (e, t, r, n) =>
              (0, s.compare)(self.Debug.VERSION, "2.3000.1027323699", ">=")
          ...
          u.injectFallbackModule("sendJoinGroupViaInvite", {
            sendJoinGroupViaInvite: async (e) => {
              const t = await (0, s.getGroupInfoFromInviteCode)(e),
                r = c.ChatStore.get(t.id.toString());
              if (r) {
                if (await (0, s.iAmMember)(t.id.toString()))
                  return { gid: r.id, membershipApprovalMode: !1 };
              }
              return {
                gid: (
                  await (0, d.joinGroupViaInvite)(e, t.membershipApprovalMode)
                ).gid,
      ...
      76966(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            e.sendOrderStatusMessageAsMerchant &&
            e.sendOrderPaymentStatusMessageAsMerchant,
        );
      },
      37008(e, t, r) {
        "use strict";
      ...
      2571(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          t,
          { queryWidExists: ["queryWidExists"] },
          (e) => e.queryWidExists && e.queryPhoneExists,
        );
      },
      54649(e, t, r) {
        "use strict";
      ...
      59604(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => "function" == typeof e.shouldHaveAccountLid,
        );
      },
      35603(e, t, r) {
        "use strict";
      ...
      29044(e, t, r) {
        ...
        ((0, n.exportModule)(
          ...
          (e, t) =>
            "WAWebContactPresenceBridge" === t ||
            !(!e.subscribePresence && !e.subscribeUserPresence),
        ),
          (0, n.exportModule)(
            t,
            { subscribeGroupPresence: "subscribeGroupPresence" },
            (e) => !!e.subscribeGroupPresence,
          ));
      },
      80214(e, t, r) {
        "use strict";
      ...
      6946(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.toUserLid || e.toUserLidOrThrow,
        );
      },
      72804(e, t, r) {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          (e) => e.toggleNewsletterAdminActivityMuteStateAction,
        );
      },
      958(e, t, r) {
        "use strict";
      ...
      50294(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          t,
          { BackendEvent: "BackendEvent", BackendEventBus: "BackendEventBus" },
          (e) => e.BackendEventBus && e.BackendEvent,
        );
      },
      84513(e, t, r) {
        "use strict";
      ...
      42865(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          { Constants: "default" },
          (e) =>
            e.default.IMG_THUMB_MAX_EDGE || e.default.WA_COMMERCE_POLICY_URL,
        );
      },
      38627(e, t, r) {
        "use strict";
        ...
        (0, r(54993).exportModule)(
          ...
          "Enviroment",
          (e) =>
            (void 0 !== e.default.isWeb && void 0 !== e.default.isWindows) ||
            (void 0 !== e.isWeb && void 0 !== e.isWindows),
        );
      },
      26740(e, t, r) {
        "use strict";
      ...
      92448(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            e.LruMediaStore &&
            "function" == typeof e.LruMediaStore.get &&
            "function" == typeof e.LruMediaStore.put &&
            "function" == typeof e.LruMediaStore.del &&
            "function" == typeof e.LruMediaStore.clear &&
            "function" == typeof e.LruMediaStore.count &&
            "function" == typeof e.LruMediaStore.has,
        );
      },
      4749(e, t, r) {
        "use strict";
      ...
      36939(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          t,
          "MediaGatingUtils",
          (e) => e.getUploadLimit && "function" == typeof e.getUploadLimit,
        );
      },
      78959(e, t, r) {
        "use strict";
      ...
      43871(e, t, r) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, "UserPrefs", (e) => {
          var t, r;
          const n =
              "function" == typeof (null == e ? void 0 : e.getMaybeMePnUser),
            o = "function" == typeof (null == e ? void 0 : e.getMaybeMeUser);
          if (!n && !o) return !1;
          try {
            if (
              e &&
              "function" != typeof e.getMaybeMeUser &&
              (null === (t = e.hasOwnProperty) || void 0 === t
                ? void 0
                : t.call(e, "getMaybeMeUser"))
            )
              try {
                delete e.getMaybeMeUser;
              } catch (e) {}
            if (
              e &&
              "function" != typeof e.getMaybeMePnUser &&
              (null === (r = e.hasOwnProperty) || void 0 === r
                ? void 0
                : r.call(e, "getMaybeMePnUser"))
            )
              try {
                delete e.getMaybeMePnUser;
              } catch (e) {}
            n && !o
              ? Object.defineProperty(e, "getMaybeMeUser", {
                  value: e.getMaybeMePnUser.bind(e),
                  configurable: !0,
                  writable: !0,
                })
              : o &&
                !n &&
                Object.defineProperty(e, "getMaybeMePnUser", {
                  value: e.getMaybeMeUser.bind(e),
                  configurable: !0,
                  writable: !0,
                });
          } catch (e) {}
      ...
      90167(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            e.getAutoDownloadPhotos && e.setAutoDownloadPhotos && e.getTheme,
        );
      },
      70924(e, t, r) {
        "use strict";
      ...
      98651(e, t, r) {
        "use strict";
        Object.defineProperty(t, "__esModule", { value: !0 });
        (0, r(54993).exportModule)(t, { CallModel: "default" }, (e, t) => {
          var r, n, o, i, a, s;
          return (
            "WAWebCallModel" === t ||
            ["call", "Call"].includes(
              (null ===
                (n =
                  null === (r = e.default) || void 0 === r
                    ? void 0
                    : r.prototype) || void 0 === n
                ? void 0
                : n.proxyName) ||
                (null ===
                  (i =
                    null === (o = e.CallModel) || void 0 === o
                      ? void 0
                      : o.prototype) || void 0 === i
                  ? void 0
                  : i.proxyName) ||
      ...
      53356(e, t, r) {
        ...
        (0, r(54993).exportModule)(
          ...
          (e) =>
            (e.Presence && e.ChatstateCollection) ||
            (e.Presence && e.Chatstate),
        );
      },
      62078(e, t, r) {
        "use strict";
      ...
      40649(e, t, r) {
        ...
        ((0, u.exportModule)(
          ...
          (0, u.exportModule)(
            ...
            (e, t) => "WAWebNewsletterCollection" === t && e.default,
          ),
          (0, u.exportModule)(
            t,
